...
const MINIMAP_LABELS = {
  skeld_01: [
    ...
    { name: 'O2',           x: 86, y: 25, w: 14, h: 12 },
    { name: 'Navigation',   x: 117, y: 28, w: 9, h: 12 },
  ],
};
