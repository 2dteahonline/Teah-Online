...
const MINIMAP_LABELS = {
  skeld_01: [
    ...
    { name: 'Security',     x: 14, y: 27, w: 8,  h: 6  },
    { name: 'Lower Engine', x: 8,  y: 40, w: 12, h: 10 },
    { name: 'MedBay',       x: 28, y: 20, w: 8,  h: 8  },
    { name: 'Electrical',   x: 24, y: 44, w: 10, h: 10 },
    { name: 'Storage',      x: 36, y: 42, w: 18, h: 11 },
    { name: 'Admin',        x: 50, y: 28, w: 10, h: 8  },
    { name: 'Weapons',      x: 66, y: 4,  w: 13, h: 10 },
    { name: 'O2',           x: 62, y: 19, w: 8,  h: 8  },
    { name: 'Navigation',   x: 78, y: 19, w: 13, h: 10 },
    { name: 'Shields',      x: 66, y: 40, w: 10, h: 8  },
    { name: 'Comms',        x: 62, y: 51, w: 8,  h: 7  },
  ],
};
