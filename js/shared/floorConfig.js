...
const FLOOR_CONFIG = {
  ...
  // ===================== CAVE DUNGEON =====================
  // Placeholder config — same 10 base mobs on all floors.
  // Will be expanded with unique mobs per floor later.
  cave: {
    1: {
      name: 'Cave Floor 1',
      subFloors: [
        {
          ...
          theme: 'cave_depths',
          waveComps: {
            1: { primary: [{ type: 'grunt', weight: 3 }], support: [{ type: 'runner', weight: 1 }], primaryPct: 0.85, theme: 'Grunt Rush' },
            2: { primary: [{ type: 'archer', weight: 3 }, { type: 'grunt', weight: 2 }], support: [{ type: 'runner', weight: 2 }], primaryPct: 0.6, theme: 'Archer Ambush' },
            3: { primary: [{ type: 'runner', weight: 3 }], support: [{ type: 'grunt', weight: 1 }], primaryPct: 0.75, theme: 'Speed Swarm' },
            4: { primary: [{ type: 'tank', weight: 3 }], support: [{ type: 'healer', weight: 2 }, { type: 'grunt', weight: 1 }], primaryPct: 0.6, theme: 'Heavy Assault' },
          },
        },
        {
          waves: [5],
        ...
        },
        {
          ...
          theme: 'cave_elite',
          waveComps: {
            6: { primary: [{ type: 'mummy', weight: 3 }], support: [{ type: 'runner', weight: 2 }, { type: 'grunt', weight: 1 }], primaryPct: 0.5, theme: 'Mummy Ambush' },
            7: { primary: [{ type: 'witch', weight: 2 }], support: [{ type: 'grunt', weight: 2 }, { type: 'tank', weight: 1 }], primaryPct: 0.3, theme: 'Witch Coven' },
            8: { primary: [{ type: 'runner', weight: 3 }, { type: 'mummy', weight: 2 }], support: [{ type: 'grunt', weight: 1 }], primaryPct: 0.65, theme: 'Blitz Wave' },
            9: { primary: [{ type: 'tank', weight: 2 }, { type: 'witch', weight: 2 }], support: [{ type: 'healer', weight: 1 }, { type: 'archer', weight: 1 }, { type: 'mummy', weight: 1 }, { type: 'runner', weight: 1 }], primaryPct: 0.5, theme: 'Elite Wave' },
          },
        },
        {
          waves: [10],
