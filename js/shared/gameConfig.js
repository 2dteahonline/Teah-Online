...
const GAME_CONFIG = {
  ...
  ENTITY_RY: 8,                 // entity hitbox vertical half-height (tight — Graal-style, vertical positioning matters)
  ...
  // --- Version ---
  GAME_UPDATE: 246,             // increment each deploy — shown on lobby version sign
};
