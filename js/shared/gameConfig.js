...
const GAME_CONFIG = {
  ...
  ENTITY_RX: 28,                // entity hitbox horizontal half-width
  ENTITY_RY: 9,                 // entity hitbox vertical half-height (flat — Graal-style ground ellipse)
  ...
  // --- Hitbox Indicator ---
  DEFAULT_HITBOX_RX: 33,        // hitbox visual horizontal (BULLET_R + ENTITY_RX = 33)
  DEFAULT_HITBOX_RY: 14,        // hitbox visual vertical (BULLET_R + ENTITY_RY = 14)

  // --- Version ---
  GAME_UPDATE: 256,             // increment each deploy — shown on lobby version sign
};
