...
const GAME_CONFIG = {
  // --- Player ---
  PLAYER_BASE_SPEED: 7.08,      // base movement speed (no boots) -> 425 px/sec
  ...
  MUZZLE_OFFSET_Y: 14,           // horizontal-shot muzzle Y offset from arm (gun-side shift)
  ...
  KNOCKBACK_THRESHOLD: 0.57,    // min velocity before clearing

  // --- Hitbox Indicator ---
  DEFAULT_HITBOX_R: 33,         // hitbox visual radius (BULLET_HALF_SHORT + ENTITY_R)

  // --- Version ---
  GAME_UPDATE: 381,             // increment each deploy - shown on lobby version sign
};
