...
const FINE_DINING_CUSTOMER_TYPES = {
  regular:   { type: 'regular',   name: 'Regular',    color: '#80a0c0', partySize: [2, 4], tipMult: 1.0, moodSpeed: 0.6, patience: 1.3, coverFee: 10, weight: 0.44 },
  ...
  couple:    { type: 'couple',    name: 'Couple',     color: '#e0a0c0', partySize: [2, 2], tipMult: 1.5, moodSpeed: 0.5, patience: 1.3, coverFee: 30, weight: 0.10 },
  critic:    { type: 'critic',    name: 'Critic',     color: '#e04040', partySize: [2, 3], tipMult: 2.0, moodSpeed: 0.7, patience: 1.0, coverFee: 40, weight: 0.01 },
  celebrity: { type: 'celebrity', name: 'Celebrity',  color: '#ffd700', partySize: [2, 4], tipMult: 4.0, moodSpeed: 0.5, patience: 1.5, coverFee: 100, weight: 0.05 },
};
