...
let sparLearning = {
  ...
  opening: {
    ...
    strafeLeft: 0.209,
    route: 'bottomCenter',
    routeCounts: { bottomLeft: 44, bottomRight: 28, bottomCenter: 143, topHold: 0, midFlank: 13, midStrafe: 37 },
    speedPct: 0.473,
    firstShotFrame: 70.22,
    shootsDuringOpening: 0.99998,
  ...
  botOpenings: {
    ...
    routeResults: {
      ...
      midFlank:     { wins: 65, losses: 123, gotBottom: 26, total: 188 },
  ...
  shotByPosition: {
    ...
    whenBelow: { upPct: 0.407, sidePct: 0.593 },
    whenLevel: { leftPct: 0.010, rightPct: 0.0 },
  },
  playerShots: {
    hitRate: 0.505,
    hitRateClose: 0.612,
    hitRateMid: 0.186,
    hitRateFar: 0.063,
    hitWhenBotStrafing: 0.172,
    hitWhenBotStill: 0.664,
    hitWhenBotApproach: 0.295,
    hitWhenBotRetreat: 0.227,
  },
  botShots: {
    hitRate: 0.072,
    dodgedRate: 0.901,
    hitWhenPlayerStrafing: 0.140,
    hitWhenPlayerStill: 0.180,
    hitWhenPlayerApproach: 0.005,
  },
  combatPatterns: {
    playerHitDist: 114,
    botHitDist: 175,
    playerDmgWhenHasBottom: 0.767,
    botDmgWhenHasBottom: 0.004,
    tradeRatio: 0.5,
  },
  winRate: 0.99998,
  history: [],  // history not checkpointed — only lives in localStorage
  // Phase 1e: Circumstance learning
  afterHit: { pressesAdvantage: 0.230, retreatsOnDamage: 0.695 },
  lowHpExpanded: { fleesPct: 0.180, killAttemptPct: 0.820 },
  chasePatterns: { giveUpFrames: 180 },
  nearWall: { cornerStuckPct: 0.048 },
  positionValue: { bottomWinCorrelation: 0.6, topPenalty: 0.3 },
  // Phase 2/3: Split data stores
  general1v1: {
    styleResults: {
      pressure: { wins: 33, losses: 60, total: 93, avgDmgDelta: -85 },
      control: { wins: 32, losses: 80, total: 112, avgDmgDelta: -35 },
      bait: { wins: 0, losses: 4, total: 4, avgDmgDelta: -100 },
    },
  },
  jeffProfile: {
    styleResults: {
  ...
  hitboxAwareness: {
    playerHorizHitRate: 0.412,
    playerVertHitRate: 0.664,
    botHorizHitRate: 0.005,
    botVertHitRate: 0.244,
    peekSuccessRate: 0.098,
  },
};
