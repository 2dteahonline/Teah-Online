...
// Checkpoint: last saved from 143 matches (2026-03-16)
...
let sparLearning = {
  ...
  opening: {
    ...
    strafeLeft: 0.274,
    route: 'midStrafe',
    routeCounts: { bottomLeft: 24, bottomRight: 20, bottomCenter: 48, topHold: 0, midFlank: 13, midStrafe: 21 },
    speedPct: 0.122,
    firstShotFrame: 215,
    shootsDuringOpening: 0.75,
    takesBottomPct: 0.696,
  },
  botOpenings: {
    lastRoute: 'midFlank',
    routeResults: {
      ...
      midFlank:     { wins: 21, losses: 29, gotBottom: 6, total: 50 },
  ...
  shotByPosition: {
    ...
    whenBelow: { upPct: 0.080, sidePct: 0.920 },
    whenLevel: { leftPct: 0.069, rightPct: 0.007 },
  },
  playerShots: {
    hitRate: 0.022,
    hitRateClose: 0.083,
    hitRateMid: 0.010,
    hitRateFar: 0.014,
    hitWhenBotStrafing: 0.078,
    hitWhenBotStill: 0.032,
    hitWhenBotApproach: 0.026,
    hitWhenBotRetreat: 0.001,
  },
  botShots: {
    hitRate: 0.089,
    dodgedRate: 0.670,
    hitWhenPlayerStrafing: 0.014,
    hitWhenPlayerStill: 0.157,
    hitWhenPlayerApproach: 0.022,
  },
  combatPatterns: {
    playerHitDist: 191,
    botHitDist: 272,
    playerDmgWhenHasBottom: 0.374,
    botDmgWhenHasBottom: 0.169,
    tradeRatio: 0.5,
  },
  winRate: 0.403,
  history: [],  // history not checkpointed — only lives in localStorage
  // Phase 1e: Circumstance learning
  afterHit: { pressesAdvantage: 0.233, retreatsOnDamage: 0.344 },
  lowHpExpanded: { fleesPct: 0.413, killAttemptPct: 0.587 },
  chasePatterns: { giveUpFrames: 145 },
  nearWall: { cornerStuckPct: 0.164 },
  ...
  general1v1: {
    styleResults: {
      ...
      control: { wins: 7, losses: 18, total: 25, avgDmgDelta: 47 },
