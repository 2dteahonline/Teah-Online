...
// Checkpoint: last saved from 70 matches (2026-03-16)
...
let sparLearning = {
  ...
  botOpenings: {
    ...
    routeResults: {
      ...
      midFlank:     { wins: 1, losses: 14, gotBottom: 0, total: 15 },
      mirrorPlayer: { wins: 2, losses: 10, gotBottom: 10, total: 12 },
    },
  },
  position: {
    bottomBias: 0.799,
  ...
  shotByPosition: {
    whenAbove: { downPct: 0.145, sidePct: 0.855 },
    whenBelow: { upPct: 0.030, sidePct: 0.970 },
    whenLevel: { leftPct: 0.005, rightPct: 0.0001 },
  },
  playerShots: {
    hitRate: 0.303,
    hitRateClose: 0.230,
    hitRateMid: 0.066,
    hitRateFar: 0.372,
    hitWhenBotStrafing: 0.478,
    hitWhenBotStill: 0.087,
    hitWhenBotApproach: 0.203,
    hitWhenBotRetreat: 0.076,
  },
  botShots: {
    hitRate: 0.069,
    dodgedRate: 0.912,
    hitWhenPlayerStrafing: 0.043,
    hitWhenPlayerStill: 0.227,
    hitWhenPlayerApproach: 0.066,
  },
  combatPatterns: {
    playerHitDist: 385,
    botHitDist: 149,
    playerDmgWhenHasBottom: 0.025,
    botDmgWhenHasBottom: 0.003,
    tradeRatio: 0.5,
  },
  winRate: 1.0,
