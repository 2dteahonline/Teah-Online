...
const LEVELS = {
  lobby_01: {
    ...
    entities: [
      ...
      { type: 'casino_entrance', tx: 71, ty: 31, w: 3, h: 2, solid: false, target: 'casino_01', spawnTX: 28, spawnTY: 37 },
      ...
      // === SPAR BUILDING (west district, below Hide & Seek) ===
      { type: 'building_spar', tx: 14, ty: 24, w: 7, h: 8, solid: true },
      { type: 'spar_entrance', tx: 16, ty: 31, w: 3, h: 2, solid: false, target: 'spar_hub_01', spawnTX: 15, spawnTY: 18 },
  ...
  deli_01: {
    ...
    entities: [
      ...
      // === DINING AREA (right side — 2 tables, side chairs only) ===
      // Table 1 (28,4) — 3w × 2h, left and right side chairs only
      ...
      // Table 2 (28,17) — 3w × 2h, left and right side chairs only
  ...
  diner_01: {
    ...
    entities: [
      ...
      // === INGREDIENT STATIONS (2x2 each, 5 cols × 4 rows, 2-tile walkable gaps) ===
      // Row 1 (ty: 1)
      ...
      { type: 'ding_hash_browns', tx: 17, ty: 1, w: 2, h: 2, solid: true },
      // Row 2 (ty: 5)
      { type: 'ding_toast', tx: 1, ty: 5, w: 2, h: 2, solid: true },
      { type: 'ding_butter', tx: 5, ty: 5, w: 2, h: 2, solid: true },
      { type: 'ding_syrup', tx: 9, ty: 5, w: 2, h: 2, solid: true },
      { type: 'ding_burger_patty', tx: 13, ty: 5, w: 2, h: 2, solid: true },
      { type: 'ding_bun', tx: 17, ty: 5, w: 2, h: 2, solid: true },
      // Row 3 (ty: 9)
      { type: 'ding_fries', tx: 1, ty: 9, w: 2, h: 2, solid: true },
      { type: 'ding_hot_dog', tx: 5, ty: 9, w: 2, h: 2, solid: true },
      { type: 'ding_cheese', tx: 9, ty: 9, w: 2, h: 2, solid: true },
      { type: 'ding_lettuce', tx: 13, ty: 9, w: 2, h: 2, solid: true },
      // Row 4 (ty: 13)
      { type: 'ding_tomato', tx: 1, ty: 13, w: 2, h: 2, solid: true },
      { type: 'ding_onion', tx: 5, ty: 13, w: 2, h: 2, solid: true },
      { type: 'ding_milkshake_base', tx: 9, ty: 13, w: 2, h: 2, solid: true },
  ...
  fine_dining_01: {
    ...
    collisionAscii: [
      ...
      "#..........................................#",  // ty:12
      "#..........................................#",  // ty:13
      "#..........................................#",  // ty:14 (service wall door gap)
      "#..........................................#",  // ty:15 (service wall door gap)
      "#..........................................#",  // ty:16
      "#..........................................#",  // ty:17
    ...
    entities: [
      // Exit door handled by fd_exit_door below (fine_dining_exit removed — it overlapped spawn point)
  ...
  vortalis_01: {
    ...
    entities: [
      { type: 'vortalis_exit', tx: 17, ty: 21, w: 6, h: 3, solid: false, target: 'lobby_01', spawnTX: 53, spawnTY: 22 },
      { type: 'dungeon_door', tx: 17, ty: 1, w: 6, h: 3, solid: true },
  ...
  earth205_01: {
    ...
    entities: [
      { type: 'earth205_exit', tx: 17, ty: 21, w: 6, h: 3, solid: false, target: 'lobby_01', spawnTX: 53, spawnTY: 34 },
      { type: 'dungeon_door', tx: 17, ty: 1, w: 6, h: 3, solid: true },
  ...
  wagashi_01: {
    ...
    entities: [
      { type: 'wagashi_exit', tx: 17, ty: 21, w: 6, h: 3, solid: false, target: 'lobby_01', spawnTX: 53, spawnTY: 46 },
      { type: 'dungeon_door', tx: 17, ty: 1, w: 6, h: 3, solid: true },
  ...
  earth216_01: {
    ...
    entities: [
      { type: 'earth216_exit', tx: 17, ty: 21, w: 6, h: 3, solid: false, target: 'lobby_01', spawnTX: 53, spawnTY: 58 },
      { type: 'dungeon_door', tx: 17, ty: 1, w: 6, h: 3, solid: true },
  ...
  casino_01: {
    ...
    entities: [
      ...
      { type: 'casino_exit', tx: 24, ty: 38, w: 4, h: 1, solid: false, target: 'lobby_01', spawnTX: 72, spawnTY: 33 },

      // Carpet (non-solid, visual floor)
      { type: 'casino_carpet', tx: 3, ty: 3, w: 50, h: 34, solid: false },

      // Bar counter (top center)
      { type: 'casino_bar', tx: 22, ty: 2, w: 12, h: 2, solid: true },

      // Game stations — Top row (tx:8, tx:24, tx:40)
      { type: 'casino_blackjack', tx: 8,  ty: 5,  w: 3, h: 2, solid: true },
      { type: 'casino_roulette',  tx: 24, ty: 5,  w: 3, h: 2, solid: true },
      { type: 'casino_slots',     tx: 40, ty: 5,  w: 3, h: 2, solid: true },

      // Game stations — Middle row
      { type: 'casino_dice',      tx: 8,  ty: 14, w: 3, h: 2, solid: true },
      { type: 'casino_rps',       tx: 24, ty: 14, w: 3, h: 2, solid: true },
      { type: 'casino_mines',     tx: 40, ty: 14, w: 3, h: 2, solid: true },

      // Game stations — Bottom row
      { type: 'casino_coinflip',  tx: 8,  ty: 22, w: 3, h: 2, solid: true },
      { type: 'casino_baccarat',  tx: 24, ty: 22, w: 3, h: 2, solid: true },
      { type: 'casino_cases',     tx: 40, ty: 22, w: 3, h: 2, solid: true },

      // Game stations — New row
      { type: 'casino_keno',      tx: 16, ty: 30, w: 3, h: 2, solid: true },

      // Pillars
      { type: 'casino_pillar', tx: 5,  ty: 10, w: 1, h: 1, solid: true },
      { type: 'casino_pillar', tx: 50, ty: 10, w: 1, h: 1, solid: true },
      { type: 'casino_pillar', tx: 5,  ty: 20, w: 1, h: 1, solid: true },
      { type: 'casino_pillar', tx: 50, ty: 20, w: 1, h: 1, solid: true },
      { type: 'casino_pillar', tx: 5,  ty: 30, w: 1, h: 1, solid: true },
      { type: 'casino_pillar', tx: 50, ty: 30, w: 1, h: 1, solid: true },

      // Torches
      { type: 'torch', tx: 1,  ty: 1,  solid: false },
      { type: 'torch', tx: 54, ty: 1,  solid: false },
      { type: 'torch', tx: 1,  ty: 15, solid: false },
      { type: 'torch', tx: 54, ty: 15, solid: false },
      { type: 'torch', tx: 1,  ty: 30, solid: false },
      { type: 'torch', tx: 54, ty: 30, solid: false },
      { type: 'torch', tx: 1,  ty: 38, solid: false },
      { type: 'torch', tx: 54, ty: 38, solid: false },
    ],
  },
  // ===================== SPAR BUILDING LEVELS =====================
  spar_hub_01: {
    id: 'spar_hub_01',
    widthTiles: 30,
    heightTiles: 20,
    isSpar: true,
    spawns: { p1: { tx: 15, ty: 18 } },
    collisionAscii: [
      "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
      "@............................@",
      "@............................@",
    ...
    entities: [
      // Interior floor
      { type: 'spar_hub_floor', tx: 1, ty: 1, w: 28, h: 18, solid: false },
      // Left column — standard rooms
      { type: 'spar_room_door', tx: 3,  ty: 3,  w: 2, h: 2, solid: false, roomId: 'spar_1v1',  label: '1v1',  mode: 'standard' },
      { type: 'spar_room_door', tx: 3,  ty: 6,  w: 2, h: 2, solid: false, roomId: 'spar_2v2',  label: '2v2',  mode: 'standard' },
      { type: 'spar_room_door', tx: 3,  ty: 9,  w: 2, h: 2, solid: false, roomId: 'spar_3v3',  label: '3v3',  mode: 'standard' },
      { type: 'spar_room_door', tx: 3,  ty: 12, w: 2, h: 2, solid: false, roomId: 'spar_4v4',  label: '4v4',  mode: 'standard' },
      // Right column — streak rooms
      { type: 'spar_room_door', tx: 25, ty: 3,  w: 2, h: 2, solid: false, roomId: 'spar_1v1_streak', label: '1v1',  mode: 'streak' },
      { type: 'spar_room_door', tx: 25, ty: 6,  w: 2, h: 2, solid: false, roomId: 'spar_2v2_streak', label: '2v2',  mode: 'streak' },
      { type: 'spar_room_door', tx: 25, ty: 9,  w: 2, h: 2, solid: false, roomId: 'spar_3v3_streak', label: '3v3',  mode: 'streak' },
      { type: 'spar_room_door', tx: 25, ty: 12, w: 2, h: 2, solid: false, roomId: 'spar_4v4_streak', label: '4v4',  mode: 'streak' },
      // South exit
      { type: 'spar_exit', tx: 14, ty: 19, w: 3, h: 1, solid: false, target: 'lobby_01', spawnTX: 17, spawnTY: 34 },
      // Decorations
      { type: 'torch', tx: 1,  ty: 1,  solid: false },
      { type: 'torch', tx: 28, ty: 1,  solid: false },
      { type: 'torch', tx: 1,  ty: 18, solid: false },
      { type: 'torch', tx: 28, ty: 18, solid: false },
    ],
  },

  // Small arena (1v1 and 2v2)
  spar_1v1_01: {
    id: 'spar_1v1_01',
    widthTiles: 24,
    heightTiles: 20,
    isSpar: true,
    isSparArena: true,
    spawns: { p1: { tx: 4, ty: 10 }, teamA: { tx: 4, ty: 10 }, teamB: { tx: 19, ty: 10 } },
    collisionAscii: [
      "@@@@@@@@@@@@@@@@@@@@@@@@",
      "@......................@",
      "@......................@",
    ...
    entities: [
      { type: 'spar_arena_floor', tx: 1, ty: 1, w: 22, h: 18, solid: false },
    ],
  },

  // Same map used for 2v2
  spar_2v2_01: {
    id: 'spar_2v2_01',
    widthTiles: 24,
    heightTiles: 20,
    isSpar: true,
    isSparArena: true,
    spawns: { p1: { tx: 4, ty: 9 }, teamA: { tx: 4, ty: 9 }, teamA2: { tx: 4, ty: 11 }, teamB: { tx: 19, ty: 9 }, teamB2: { tx: 19, ty: 11 } },
    collisionAscii: [
      "@@@@@@@@@@@@@@@@@@@@@@@@",
      "@......................@",
      "@......................@",
  ...
  spar_3v3_01: {
    ...
    isSpar: true,
    isSparArena: true,
    spawns: { p1: { tx: 5, ty: 14 }, teamA: { tx: 5, ty: 12 }, teamA2: { tx: 5, ty: 14 }, teamA3: { tx: 5, ty: 16 }, teamB: { tx: 30, ty: 12 }, teamB2: { tx: 30, ty: 14 }, teamB3: { tx: 30, ty: 16 } },
    collisionAscii: [
      "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
      "@..................................@",
      "@..................................@",
    ...
    entities: [
      { type: 'spar_arena_floor', tx: 1, ty: 1, w: 34, h: 26, solid: false },
    ],
  },

  // 4v4 uses larger version
  spar_4v4_01: {
    id: 'spar_4v4_01',
    widthTiles: 36,
    heightTiles: 28,
    isSpar: true,
    isSparArena: true,
    spawns: { p1: { tx: 5, ty: 13 }, teamA: { tx: 5, ty: 11 }, teamA2: { tx: 5, ty: 13 }, teamA3: { tx: 5, ty: 15 }, teamA4: { tx: 5, ty: 17 }, teamB: { tx: 30, ty: 11 }, teamB2: { tx: 30, ty: 13 }, teamB3: { tx: 30, ty: 15 }, teamB4: { tx: 30, ty: 17 } },
    collisionAscii: [
      "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@",
      "@..................................@",
      "@..................................@",
