...
const MOB_TYPES = {
  ...
  golem:   { name: "Golem",   hp: 1000,speed: 1.3, damage: 13, killHeal: 40, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 82, boulderRate: 88, boulderSpeed: 9, boulderRange: 1000, summonRate: 300, summonMax: 3 },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.7, damage: 6, killHeal: 10, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 50, boulderRate: 140, boulderSpeed: 9, boulderRange: 500 },
  ...
  archer:  { name: "Archer",  hp: 75,  speed: 2.6, damage: 6,  killHeal: 8,  skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 74, arrowRate: 80, arrowSpeed: 9, arrowRange: 400, arrowBounces: 4, arrowLife: 600 },
