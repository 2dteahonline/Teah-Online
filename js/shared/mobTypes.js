...
const MOB_TYPES = {
  ...
  runner:  { name: "Runner",  hp: 50,  speed: 3.44, damage: 10, killHeal: 3,  skin: "#8a7060", hair: "#1a1a1a", shirt: "#884444", pants: "#4a2a2a", contactRange: 74 },
  ...
  golem:   { name: "Golem",   hp: 1000,speed: 1.1, damage: 13, killHeal: 40, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 82, boulderRate: 88, boulderSpeed: 16, boulderRange: 1000, summonRate: 300, summonMax: 3 },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.44, damage: 6, killHeal: 10, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 50, boulderRate: 140, boulderSpeed: 12, boulderRange: 500 },
  ...
  archer:  { name: "Archer",  hp: 75,  speed: 2.19, damage: 6,  killHeal: 8,  skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 74, arrowRate: 80, arrowSpeed: 13, arrowRange: 400, arrowBounces: 4, arrowLife: 600 },
  ...
  neon_pickpocket: {
    name: "Neon Pickpocket", hp: 60, speed: 3.25, damage: 12, killHeal: 5,
    skin: "#8a7a6a", hair: "#1a1a2a", shirt: "#2a2a4a", pants: "#1a1a3a", contactRange: 74,
    ai: 'runner', _specials: ['swipe_blink'], specialCD: 420, // 7s
  },
  cyber_mugger: {
    name: "Cyber Mugger", hp: 90, speed: 2.75, damage: 16, killHeal: 8,
  ...
  drone_lookout: {
    ...
    arrowRate: 100, arrowSpeed: 12, arrowRange: 350, arrowBounces: 0, arrowLife: 400,
    projectileStyle: 'neon_bolt',
  },
  street_chemist: {
    name: "Street Chemist", hp: 65, speed: 2.0, damage: 6, killHeal: 12,
  ...
  renegade_bruiser: {
    name: "Renegade Bruiser", hp: 200, speed: 2.5, damage: 22, killHeal: 15,
  ...
  renegade_shadowknife: {
    name: "Renegade Shadowknife", hp: 55, speed: 3.5, damage: 18, killHeal: 6,
  ...
  renegade_demo: {
    name: "Renegade Demo", hp: 80, speed: 2.5, damage: 14, killHeal: 8,
  ...
  renegade_sniper: {
    ...
    arrowRate: 90, arrowSpeed: 16, arrowRange: 650, arrowBounces: 1, arrowLife: 500,
    projectileStyle: 'tracer',
  },

  // Level 5 Mini-Boss: The Don
  the_don: {
    name: "The Don", hp: 800, speed: 1.5, damage: 28, killHeal: 40,
    ...
    arrowRate: 120, arrowSpeed: 13, arrowRange: 500, arrowBounces: 0, arrowLife: 500,
  ...
  velocity: {
    name: "Velocity", hp: 1500, speed: 3.13, damage: 30, killHeal: 50,
  ...
  coil_runner: {
    name: "Coil Runner", hp: 70, speed: 3.5, damage: 8, killHeal: 5,
  ...
  voltmaster: {
    name: "Voltmaster", hp: 1000, speed: 1.63, damage: 18, killHeal: 40,
  ...
  executive_handler: {
    ...
    arrowRate: 100, arrowSpeed: 12, arrowRange: 400, arrowBounces: 0, arrowLife: 450,
    projectileStyle: 'electric_bolt',
  },

  // Level 20 Boss: E-Mortis
  e_mortis: {
    name: "E-Mortis", hp: 1800, speed: 1.88, damage: 22, killHeal: 50,
    ...
    arrowRate: 110, arrowSpeed: 13, arrowRange: 500, arrowBounces: 0, arrowLife: 500,
    projectileStyle: 'golden',
  ...
  mourn: {
    name: "Mourn", hp: 1200, speed: 1.25, damage: 24, killHeal: 40,
  ...
  centipede: {
    name: "Centipede", hp: 2200, speed: 1.5, damage: 20, killHeal: 50,
  ...
  game_master: {
    name: "Game Master", hp: 1400, speed: 1.5, damage: 18, killHeal: 40,
  ...
  junz: {
    name: "J.U.N.Z", hp: 2500, speed: 1.75, damage: 25, killHeal: 50,
    ...
    isBoss: true, bossScale: 1.5, specialCD: 540, // 9s
    arrowRate: 90, arrowSpeed: 16, arrowRange: 550, arrowBounces: 0, arrowLife: 500,
    projectileStyle: 'electric_bolt',
  ...
  lehvius: {
    name: "Lehvius", hp: 1600, speed: 2.25, damage: 22, killHeal: 40,
  ...
  jackman: {
    name: "Jackman", hp: 1200, speed: 1.75, damage: 16, killHeal: 40,
  ...
  biolum_drone: {
    name: "Bio-Lum Drone", hp: 55, speed: 3.25, damage: 10, killHeal: 5,
  ...
  malric: {
    name: "World Malric", hp: 3000, speed: 2.0, damage: 28, killHeal: 50,
  ...
  vale: {
    name: "Vale", hp: 2200, speed: 2.5, damage: 20, killHeal: 50,
