...
const MOB_TYPES = {
  grunt:   { name: "Grunt",   hp: 106, speed: 3.2, damage: 18, killHeal: 10, goldReward: 2, skin: "#7a6050", hair: "#3a2a1a", shirt: "#556644", pants: "#3a3a2a", contactRange: 76, deathColors: ["#aa4444","#884444","#cc6666","#663333"] },
  runner:  { name: "Runner",  hp: 50,  speed: 3.8, damage: 10, killHeal: 3,  goldReward: 3, skin: "#8a7060", hair: "#1a1a1a", shirt: "#884444", pants: "#4a2a2a", contactRange: 74, deathColors: ["#cc6644","#aa4422","#ee8866","#883322"] },
  tank:    { name: "Tank",    hp: 375, speed: 2.8,  damage: 20, killHeal: 20, goldReward: 6, skin: "#6a5a50", hair: "#2a2a2a", shirt: "#445566", pants: "#2a3a4a", contactRange: 78, deathColors: ["#4466aa","#335588","#6688cc","#224466"] },
  witch:   { name: "Witch",   hp: 188, speed: 1.5, damage: 6,  killHeal: 25, goldReward: 7, skin: "#8a9a7a", hair: "#2a1a3a", shirt: "#3a2a4a", pants: "#2a1a2a", contactRange: 76, summonRate: 540, summonMax: 4, deathColors: ["#a060e0","#8040c0","#c080ff","#6020a0"] },
  skeleton:{ name: "Skeleton",hp: 38,  speed: 3.2, damage: 8,  killHeal: 1,  goldReward: 0, skin: "#d8d0c0", hair: "#d0c8b8", shirt: "#c8c0b0", pants: "#b8b0a0", contactRange: 74, deathColors: ["#d8d0c0","#c8c0b0","#e0d8c8","#b8b0a0"] },
  golem:   { name: "Golem",   hp: 1000,speed: 1.2, damage: 13, killHeal: 40, goldReward: 30, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 82, boulderRate: 88, boulderSpeed: 9, boulderRange: 1000, summonRate: 300, summonMax: 3, deathColors: ["#8a8580","#6a6560","#a09a90","#585450"] },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.6, damage: 6, killHeal: 10, goldReward: 5, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 50, boulderRate: 140, boulderSpeed: 9, boulderRange: 500, deathColors: ["#9a9590","#7a7570","#b0aaa0","#686460"] },
  mummy:   { name: "Mummy",   hp: 56,  speed: 2.8,  damage: 0,  killHeal: 5,  goldReward: 3, skin: "#8a8580", hair: "#7a7570", shirt: "#6a6560", pants: "#5a5550", contactRange: 76, explodeRange: 140, explodeDamage: 28, fuseMin: 32, fuseMax: 96, deathColors: ["#c8b878","#a89858","#e0d098","#887838"] },
  archer:  { name: "Archer",  hp: 75,  speed: 2.4, damage: 6,  killHeal: 8,  goldReward: 4, skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 74, arrowRate: 80, arrowSpeed: 9, arrowRange: 400, arrowBounces: 4, arrowLife: 600, deathColors: ["#30ff20","#1a1a1a","#0e0e0e","#20cc10"] },
  healer:  { name: "Healer",  hp: 81,  speed: 1.8, damage: 5,  killHeal: 15, goldReward: 5, skin: "#e8d8c8", hair: "#f0e0c0", shirt: "#eee8dd", pants: "#d8d0c0", contactRange: 74, healRadius: 220, healRate: 72, healAmount: 10, deathColors: ["#ffdd30","#ffe870","#ffc800","#ffee90"] },
