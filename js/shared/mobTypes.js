...
const MOB_TYPES = {
  grunt:   { name: "Grunt",   hp: 106, speed: 3.9, damage: 18, killHeal: 10, goldReward: 2, skin: "#7a6050", hair: "#3a2a1a", shirt: "#556644", pants: "#3a3a2a", contactRange: 76, deathColors: ["#aa4444","#884444","#cc6666","#663333"] },
  runner:  { name: "Runner",  hp: 50,  speed: 4.6, damage: 10, killHeal: 3,  goldReward: 3, skin: "#8a7060", hair: "#1a1a1a", shirt: "#884444", pants: "#4a2a2a", contactRange: 74, deathColors: ["#cc6644","#aa4422","#ee8866","#883322"] },
  tank:    { name: "Tank",    hp: 375, speed: 3.4,  damage: 20, killHeal: 20, goldReward: 6, skin: "#6a5a50", hair: "#2a2a2a", shirt: "#445566", pants: "#2a3a4a", contactRange: 78, deathColors: ["#4466aa","#335588","#6688cc","#224466"] },
  witch:   { name: "Witch",   hp: 188, speed: 1.8, damage: 6,  killHeal: 25, goldReward: 7, skin: "#8a9a7a", hair: "#2a1a3a", shirt: "#3a2a4a", pants: "#2a1a2a", contactRange: 76, summonRate: 540, summonMax: 4, deathColors: ["#a060e0","#8040c0","#c080ff","#6020a0"] },
  skeleton:{ name: "Skeleton",hp: 38,  speed: 3.9, damage: 8,  killHeal: 1,  goldReward: 0, skin: "#d8d0c0", hair: "#d0c8b8", shirt: "#c8c0b0", pants: "#b8b0a0", contactRange: 74, deathColors: ["#d8d0c0","#c8c0b0","#e0d8c8","#b8b0a0"] },
  golem:   { name: "Golem",   hp: 1000,speed: 1.5, damage: 13, killHeal: 40, goldReward: 30, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 82, boulderRate: 88, boulderSpeed: 9, boulderRange: 1000, summonRate: 300, summonMax: 3, deathColors: ["#8a8580","#6a6560","#a09a90","#585450"] },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.9, damage: 6, killHeal: 10, goldReward: 5, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 50, boulderRate: 140, boulderSpeed: 9, boulderRange: 500, deathColors: ["#9a9590","#7a7570","#b0aaa0","#686460"] },
  mummy:   { name: "Mummy",   hp: 56,  speed: 3.4,  damage: 0,  killHeal: 5,  goldReward: 3, skin: "#8a8580", hair: "#7a7570", shirt: "#6a6560", pants: "#5a5550", contactRange: 76, explodeRange: 140, explodeDamage: 28, fuseMin: 32, fuseMax: 96, deathColors: ["#c8b878","#a89858","#e0d098","#887838"] },
  archer:  { name: "Archer",  hp: 75,  speed: 2.9, damage: 6,  killHeal: 8,  goldReward: 4, skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 74, arrowRate: 80, arrowSpeed: 9, arrowRange: 400, arrowBounces: 4, arrowLife: 600, deathColors: ["#30ff20","#1a1a1a","#0e0e0e","#20cc10"] },
  healer:  { name: "Healer",  hp: 81,  speed: 2.2, damage: 5,  killHeal: 15, goldReward: 5, skin: "#e8d8c8", hair: "#f0e0c0", shirt: "#eee8dd", pants: "#d8d0c0", contactRange: 74, healRadius: 220, healRate: 72, healAmount: 10, deathColors: ["#ffdd30","#ffe870","#ffc800","#ffee90"] },
  ...
  cyber_mugger: {
    name: "Cyber Mugger", hp: 90, speed: 3.7, damage: 16, killHeal: 8, goldReward: 4,
  ...
  street_chemist: {
    name: "Street Chemist", hp: 65, speed: 2.7, damage: 6, killHeal: 12, goldReward: 5,
  ...
  the_don: {
    name: "The Don", hp: 800, speed: 2, damage: 28, killHeal: 40, goldReward: 25,
  ...
  circuit_thief: {
    name: "Circuit Thief", hp: 75, speed: 4.1, damage: 10, killHeal: 5, goldReward: 4,
  ...
  compliance_officer: {
    name: "Compliance Officer", hp: 80, speed: 2.7, damage: 10, killHeal: 8, goldReward: 5,
  ...
  scrap_rat: {
    name: "Scrap Rat", hp: 80, speed: 3.7, damage: 10, killHeal: 5, goldReward: 4,
  ...
  rust_sawman: {
    name: "Rust Sawman", hp: 85, speed: 4.1, damage: 16, killHeal: 6, goldReward: 5,
  ...
  centipede: {
    name: "Centipede", hp: 2200, speed: 2, damage: 20, killHeal: 50, goldReward: 50,
  ...
  holo_jester: {
    name: "Holo Jester", hp: 75, speed: 3.7, damage: 10, killHeal: 8, goldReward: 5,
    skin: "#8a8a9a", hair: "#5a5a6a", shirt: "#7a4a8a", pants: "#5a3a6a", contactRange: 76,
    ai: 'witch', _specials: ['fake_wall'], specialCD: 840, // 14s
    kiteRange: 280,
  },
  time_prankster: {
    name: "Time Prankster", hp: 65, speed: 4.1, damage: 12, killHeal: 6, goldReward: 5,
  ...
  game_master: {
    name: "Game Master", hp: 1400, speed: 2, damage: 18, killHeal: 40, goldReward: 40,
  ...
  enforcer_drone: {
    name: "Enforcer Drone", hp: 100, speed: 3.7, damage: 14, killHeal: 8, goldReward: 6,
    skin: "#6a6a7a", hair: "#3a3a4a", shirt: "#4a4a5a", pants: "#3a3a4a", contactRange: 76,
    ai: 'grunt', _specials: ['suppress_cone'], specialCD: 480, // 8s
  },
  synth_builder: {
    name: "Synth Builder", hp: 110, speed: 2.7, damage: 10, killHeal: 10, goldReward: 6,
  ...
  junz: {
    name: "J.U.N.Z", hp: 2500, speed: 2.4, damage: 25, killHeal: 50, goldReward: 55,
  ...
  spore_stag: {
    name: "Spore Stag", hp: 120, speed: 4, damage: 20, killHeal: 8, goldReward: 6,
  ...
  wasteland_raptor: {
    name: "Wasteland Raptor", hp: 95, speed: 5, damage: 16, killHeal: 5, goldReward: 4,
  ...
  anchor_hauler: {
    name: "Anchor Hauler", hp: 150, speed: 2.7, damage: 18, killHeal: 15, goldReward: 6,
  ...
  tidecaller_mystic: {
    name: "Tidecaller Mystic", hp: 80, speed: 2.7, damage: 10, killHeal: 12, goldReward: 5,
  ...
  sunken_dreadnought: {
    name: "Sunken Dreadnought", hp: 220, speed: 2.4, damage: 24, killHeal: 15, goldReward: 7,
  ...
  admiral_von_kael: {
    name: "Admiral Von Kael", hp: 1200, speed: 2, damage: 24, killHeal: 40, goldReward: 30,
  ...
  jungle_headhunter: {
    name: "Jungle Headhunter", hp: 80, speed: 4.5, damage: 14, killHeal: 5, goldReward: 4,
  ...
  voodoo_creeper: {
    name: "Voodoo Creeper", hp: 70, speed: 2.7, damage: 8, killHeal: 12, goldReward: 5,
  ...
  temple_silverback: {
    name: "Temple Silverback", hp: 200, speed: 3.2, damage: 22, killHeal: 15, goldReward: 6,
  ...
  zongo: {
    name: "Zongo", hp: 1100, speed: 2.5, damage: 26, killHeal: 40, goldReward: 30,
  ...
  crystal_cultist: {
    name: "Crystal Cultist", hp: 75, speed: 2.7, damage: 10, killHeal: 12, goldReward: 5,
  ...
  rabid_wharf_hound: {
    name: "Rabid Wharf Hound", hp: 100, speed: 4.1, damage: 18, killHeal: 8, goldReward: 4,
  ...
  wolfbeard: {
    name: "Wolfbeard", hp: 1600, speed: 3.2, damage: 28, killHeal: 40, goldReward: 35,
  ...
  phantom_swashbuckler: {
    name: "Phantom Swashbuckler", hp: 80, speed: 4.5, damage: 18, killHeal: 5, goldReward: 4,
  ...
  drowned_banshee: {
    name: "Drowned Banshee", hp: 75, speed: 2.7, damage: 10, killHeal: 12, goldReward: 5,
  ...
  ghostbeard: {
    name: "Ghostbeard", hp: 1800, speed: 2.7, damage: 26, killHeal: 40, goldReward: 35,
  ...
  coral_crusher: {
    name: "Coral Crusher", hp: 200, speed: 2.7, damage: 22, killHeal: 15, goldReward: 6,
  ...
  barnacle_bomber: {
    name: "Barnacle Bomber", hp: 90, speed: 3.7, damage: 16, killHeal: 8, goldReward: 4,
  ...
  deep_sea_dredger: {
    name: "Deep-Sea Dredger", hp: 210, speed: 2.5, damage: 24, killHeal: 15, goldReward: 7,
  ...
  royal_cephalopod: {
    name: "Royal Cephalopod", hp: 85, speed: 2.7, damage: 12, killHeal: 12, goldReward: 5,
  ...
  king_requill: {
    name: "King Requill", hp: 2800, speed: 2, damage: 30, killHeal: 50, goldReward: 45,
  ...
  reef_weaver: {
    name: "Reef Weaver", hp: 80, speed: 2.7, damage: 12, killHeal: 12, goldReward: 5,
  ...
  royal_shell_knight: {
    name: "Royal Shell Knight", hp: 220, speed: 2.7, damage: 24, killHeal: 15, goldReward: 7,
  ...
  living_whirlpool: {
    name: "Living Whirlpool", hp: 90, speed: 2.5, damage: 14, killHeal: 12, goldReward: 5,
  ...
  bone_tooth_zealot: {
    name: "Bone Tooth Zealot", hp: 130, speed: 3.7, damage: 22, killHeal: 8, goldReward: 5,
  ...
  mami_wata: {
    name: "Mami Wata", hp: 4000, speed: 2.5, damage: 34, killHeal: 50, goldReward: 60,
  ...
  patchwork_thug: {
    name: "Patchwork Thug", hp: 160, speed: 3.9, damage: 24, killHeal: 8, goldReward: 5,
  ...
  willis: {
    name: "Willis", hp: 2500, speed: 3.2, damage: 38, killHeal: 50, goldReward: 40,
  ...
  butcher_block_maniac: {
    name: "Butcher Block Maniac", hp: 180, speed: 3.9, damage: 26, killHeal: 8, goldReward: 5,
  ...
  adrenaline_fiend: {
    name: "Adrenaline Fiend", hp: 140, speed: 5, damage: 28, killHeal: 5, goldReward: 4,
  ...
  nail_gunner: {
    name: "Nail Gunner", hp: 150, speed: 2.7, damage: 22, killHeal: 10, goldReward: 6,
  ...
  chain_gang_brawler: {
    name: "Chain Gang Brawler", hp: 190, speed: 3.9, damage: 26, killHeal: 8, goldReward: 6,
  ...
  riot_juggernaut: {
    name: "Riot Juggernaut", hp: 280, speed: 3.2, damage: 34, killHeal: 15, goldReward: 7,
  ...
  macabre_dancer: {
    name: "Macabre Dancer", hp: 150, speed: 4.5, damage: 24, killHeal: 5, goldReward: 5,
  ...
  arsonist: {
    name: "Arsonist", hp: 200, speed: 3.9, damage: 28, killHeal: 8, goldReward: 6,
  ...
  executioner_bruiser: {
    name: "Executioner Bruiser", hp: 220, speed: 4.1, damage: 30, killHeal: 8, goldReward: 6,
  ...
  laser_grid_thief: {
    name: "Laser Grid Thief", hp: 160, speed: 4.9, damage: 26, killHeal: 5, goldReward: 5,
  ...
  tactical_spotter: {
    name: "Tactical Spotter", hp: 170, speed: 2.7, damage: 24, killHeal: 10, goldReward: 6,
  ...
  breacher_unit: {
    name: "Breacher Unit", hp: 210, speed: 4.1, damage: 28, killHeal: 8, goldReward: 6,
  ...
  balloon_twister: {
    name: "Balloon Twister", hp: 180, speed: 2, damage: 22, killHeal: 12, goldReward: 6,
  ...
  stagehand_brute: {
    name: "Stagehand Brute", hp: 230, speed: 3.9, damage: 30, killHeal: 8, goldReward: 6,
  ...
  juggling_jester: {
    name: "Juggling Jester", hp: 170, speed: 4.5, damage: 24, killHeal: 5, goldReward: 5,
  ...
  prop_master: {
    name: "Prop Master", hp: 210, speed: 3.2, damage: 28, killHeal: 10, goldReward: 6,
  ...
  disco_brawler: {
    name: "Disco Brawler", hp: 190, speed: 4.5, damage: 30, killHeal: 5, goldReward: 5,
  ...
  major_phantom: {
    name: "Major Phantom", hp: 4500, speed: 3.2, damage: 52, killHeal: 50, goldReward: 60,
  ...
  tracksuit_goon: {
    name: "Tracksuit Goon", hp: 240, speed: 3.9, damage: 30, killHeal: 8, goldReward: 7,
  ...
  vault_hacker: {
    name: "Vault Hacker", hp: 200, speed: 2, damage: 26, killHeal: 12, goldReward: 7,
  ...
  casino_pit_boss: {
    name: "Casino Pit Boss", hp: 270, speed: 4.1, damage: 34, killHeal: 8, goldReward: 7,
  ...
  mad_assistant: {
    name: "Mad Assistant", hp: 220, speed: 2.7, damage: 28, killHeal: 10, goldReward: 7,
  ...
  hazmat_grunt: {
    name: "Hazmat Grunt", hp: 290, speed: 3.9, damage: 34, killHeal: 8, goldReward: 7,
  ...
  sludge_crawler: {
    name: "Sludge Crawler", hp: 220, speed: 4.5, damage: 30, killHeal: 5, goldReward: 6,
  ...
  reactor_technician: {
    name: "Reactor Technician", hp: 240, speed: 3.2, damage: 30, killHeal: 10, goldReward: 7,
  ...
  containment_breach_blob: {
    name: "Containment Breach", hp: 280, speed: 2, damage: 26, killHeal: 12, goldReward: 7,
  ...
  nofaux: {
    name: "Nofaux", hp: 6000, speed: 4, damage: 60, killHeal: 50, goldReward: 75,
  ...
  copperhide_hoglet: {
    name: "Copperhide Hoglet", hp: 240, speed: 4, damage: 32, killHeal: 10, goldReward: 6,
  ...
  temple_fang_acolyte: {
    name: "Temple Fang Acolyte", hp: 280, speed: 4.5, damage: 32, killHeal: 10, goldReward: 6,
  ...
  jade_vein_stalker: {
    name: "Jade Vein Stalker", hp: 310, speed: 4.5, damage: 38, killHeal: 12, goldReward: 7,
  ...
  pillarbreaker_brute: {
    name: "Pillarbreaker Brute", hp: 340, speed: 3.9, damage: 40, killHeal: 12, goldReward: 7,
  ...
  tempest_spearman: {
    name: "Tempest Spearman", hp: 380, speed: 4.1, damage: 42, killHeal: 14, goldReward: 8,
  ...
  tideblade_disciple: {
    name: "Tideblade Disciple", hp: 420, speed: 3.9, damage: 44, killHeal: 14, goldReward: 8,
  ...
  azure_dragon: {
    name: "Azure Dragon", hp: 5500, speed: 4.5, damage: 55, killHeal: 50, goldReward: 40,
  ...
  ember_guard: {
    name: "Ember Guard", hp: 440, speed: 4.1, damage: 44, killHeal: 14, goldReward: 8,
  ...
  crimson_furnace_captain: {
    name: "Crimson Furnace Captain", hp: 480, speed: 3.9, damage: 48, killHeal: 20, goldReward: 10,
  ...
  lantern_veil_assassin: {
    name: "Lantern Veil Assassin", hp: 450, speed: 5.7, damage: 42, killHeal: 15, goldReward: 8,
  ...
  blood_script_archer: {
    name: "Blood Script Archer", hp: 480, speed: 4, damage: 44, killHeal: 18, goldReward: 10,
  ...
  crimson_gate_executioner: {
    name: "Crimson Gate Executioner", hp: 550, speed: 4, damage: 52, killHeal: 22, goldReward: 11,
  ...
  lunar_dust_hare: {
    name: "Lunar Dust Hare", hp: 460, speed: 5.7, damage: 44, killHeal: 15, goldReward: 8,
  ...
  crescent_mirror_wisp: {
    name: "Crescent Mirror Wisp", hp: 480, speed: 4, damage: 42, killHeal: 18, goldReward: 9,
  ...
  gravity_ear_monk: {
    name: "Gravity Ear Monk", hp: 500, speed: 4, damage: 46, killHeal: 20, goldReward: 10,
  ...
  gulchspine_bloater: {
    name: "Gulchspine Bloater", hp: 600, speed: 4, damage: 52, killHeal: 20, goldReward: 10,
  ...
  hymn_eater_toadlet: {
    name: "Hymn Eater Toadlet", hp: 560, speed: 4, damage: 48, killHeal: 22, goldReward: 11,
  ...
  abyssal_swallower: {
    name: "Abyssal Swallower", hp: 650, speed: 4, damage: 56, killHeal: 25, goldReward: 12,
  ...
  celestial_toad: {
    name: "Celestial Toad", hp: 7500, speed: 4, damage: 65, killHeal: 60, goldReward: 50,
  ...
  shrine_shard_monkey: {
    name: "Shrine Shard Monkey", hp: 540, speed: 5.7, damage: 50, killHeal: 18, goldReward: 9,
  ...
  seal_fragment_sprite: {
    name: "Seal Fragment Sprite", hp: 580, speed: 4, damage: 48, killHeal: 22, goldReward: 11,
  ...
  heavens_gate_breaker: {
    name: "Heaven's Gate Breaker", hp: 650, speed: 4, damage: 58, killHeal: 25, goldReward: 12,
  ...
  lord_sarugami: {
    name: "Lord Sarugami", hp: 8500, speed: 4.5, damage: 75, killHeal: 70, goldReward: 65,
  ...
  pit_bruiser: {
    name: "Pit Bruiser", hp: 350, speed: 3.2, damage: 38, killHeal: 15, goldReward: 8,
  ...
  vault_hound_e216: {
    name: "Vault Hound", hp: 220, speed: 5.4, damage: 28, killHeal: 6, goldReward: 5,
  ...
  victor_graves: {
    name: "Victor Graves", hp: 4000, speed: 3.2, damage: 48, killHeal: 40, goldReward: 30,
  ...
  gilded_maid: {
    name: "Gilded Maid", hp: 280, speed: 3.9, damage: 34, killHeal: 12, goldReward: 7,
  ...
  bullion_knight: {
    name: "Bullion Knight", hp: 380, speed: 3.2, damage: 40, killHeal: 16, goldReward: 9,
  ...
  scar_punk: {
    name: "Scar Punk", hp: 270, speed: 4.5, damage: 34, killHeal: 10, goldReward: 6,
  ...
  splitjaw: {
    name: "Splitjaw", hp: 240, speed: 4.9, damage: 32, killHeal: 8, goldReward: 5,
  ...
  razorback_youth: {
    name: "Razorback Youth", hp: 210, speed: 5.4, damage: 28, killHeal: 6, goldReward: 5,
  ...
  grin_stitcher: {
    name: "Grin Stitcher", hp: 290, speed: 3.9, damage: 34, killHeal: 12, goldReward: 7,
  ...
  slasher_e216: {
    name: "Slasher", hp: 4500, speed: 4.5, damage: 52, killHeal: 40, goldReward: 35,
  ...
  velvet_mourner: {
    name: "Velvet Mourner", hp: 300, speed: 4.1, damage: 34, killHeal: 14, goldReward: 8,
  ...
  candle_child: {
    name: "Candle Child", hp: 260, speed: 3.9, damage: 32, killHeal: 10, goldReward: 6,
  ...
  ofrenda_keeper: {
    name: "Ofrenda Keeper", hp: 320, speed: 3.2, damage: 30, killHeal: 16, goldReward: 9,
  ...
  macabre_e216: {
    name: "Macabre", hp: 5000, speed: 3.9, damage: 55, killHeal: 40, goldReward: 35,
  ...
  candle_bride: {
    name: "Candle Bride", hp: 280, speed: 3.9, damage: 36, killHeal: 12, goldReward: 7,
  ...
  road_reaper: {
    name: "Road Reaper", hp: 280, speed: 4.5, damage: 36, killHeal: 10, goldReward: 7,
  ...
  rev_hound: {
    name: "Rev Hound", hp: 220, speed: 5.7, damage: 30, killHeal: 6, goldReward: 5,
  ...
  drift_phantom: {
    name: "Drift Phantom", hp: 240, speed: 5.7, damage: 34, killHeal: 8, goldReward: 6,
    skin: "#5a5a6a", hair: "#1a1a2a", shirt: "#3a3a4a", pants: "#1a1a2a", contactRange: 74,
    ai: 'runner', _specials: ['drift_blink'], specialCD: 420, // 7s
    deathColors: ["#5a5a6a","#3a3a4a","#7a7a8a","#1a1a2a"],
  },
  crash_dummy: {
    name: "Crash Dummy", hp: 300, speed: 4.1, damage: 38, killHeal: 12, goldReward: 7,
  ...
  neon_screamer: {
    name: "Neon Screamer", hp: 280, speed: 4.5, damage: 34, killHeal: 14, goldReward: 8,
  ...
  ramp_widow: {
    name: "Ramp Widow", hp: 290, speed: 4.1, damage: 36, killHeal: 14, goldReward: 8,
  ...
  nitro_wraith: {
    name: "Nitro Wraith", hp: 6500, speed: 5.7, damage: 62, killHeal: 50, goldReward: 45,
  ...
  roulette_revenant: {
    name: "Roulette Revenant", hp: 290, speed: 4.1, damage: 36, killHeal: 12, goldReward: 7,
  ...
  suit_reaper: {
    name: "Suit Reaper", hp: 280, speed: 3.9, damage: 36, killHeal: 12, goldReward: 7,
  ...
  blight_husk: {
    name: "Blight Husk", hp: 300, speed: 3.9, damage: 36, killHeal: 12, goldReward: 7,
    skin: "#4a5a3a", hair: "#1a2a0a", shirt: "#3a4a2a", pants: "#1a2a0a", contactRange: 76,
    ai: 'grunt', _specials: ['blight_burst'], specialCD: 480, // 8s
    deathColors: ["#4a5a3a","#3a4a2a","#6a7a5a","#1a2a0a"],
  },
  maw_sprite: {
    name: "Maw Sprite", hp: 230, speed: 5.4, damage: 32, killHeal: 6, goldReward: 6,
  ...
  alcazar: {
    name: "Alcazar", hp: 8500, speed: 3.9, damage: 70, killHeal: 70, goldReward: 65,
