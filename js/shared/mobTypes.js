...
const MOB_TYPES = {
  ...
  runner:  { name: "Runner",  hp: 50,  speed: 4.1, damage: 10, killHeal: 3,  skin: "#8a7060", hair: "#1a1a1a", shirt: "#884444", pants: "#4a2a2a", contactRange: 74 },
  tank:    { name: "Tank",    hp: 375, speed: 3.0,  damage: 20, killHeal: 20, skin: "#6a5a50", hair: "#2a2a2a", shirt: "#445566", pants: "#2a3a4a", contactRange: 78 },
  witch:   { name: "Witch",   hp: 188, speed: 1.6, damage: 6,  killHeal: 25, skin: "#8a9a7a", hair: "#2a1a3a", shirt: "#3a2a4a", pants: "#2a1a2a", contactRange: 76, summonRate: 540, summonMax: 4 },
  skeleton:{ name: "Skeleton",hp: 38,  speed: 3.4, damage: 8,  killHeal: 1,  skin: "#d8d0c0", hair: "#d0c8b8", shirt: "#c8c0b0", pants: "#b8b0a0", contactRange: 74 },
  golem:   { name: "Golem",   hp: 1000,speed: 1.3, damage: 13, killHeal: 40, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 82, boulderRate: 88, boulderSpeed: 18.9, boulderRange: 1000, summonRate: 300, summonMax: 3 },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.7, damage: 6, killHeal: 10, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 50, boulderRate: 140, boulderSpeed: 13.5, boulderRange: 500 },
  mummy:   { name: "Mummy",   hp: 56,  speed: 3.0,  damage: 0,  killHeal: 5,  skin: "#8a8580", hair: "#7a7570", shirt: "#6a6560", pants: "#5a5550", contactRange: 76, explodeRange: 140, explodeDamage: 28, fuseMin: 32, fuseMax: 96 },
  archer:  { name: "Archer",  hp: 75,  speed: 2.6, damage: 6,  killHeal: 8,  skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 74, arrowRate: 80, arrowSpeed: 15.3, arrowRange: 400, arrowBounces: 4, arrowLife: 600 },
  healer:  { name: "Healer",  hp: 81,  speed: 1.9, damage: 5,  killHeal: 15, skin: "#e8d8c8", hair: "#f0e0c0", shirt: "#eee8dd", pants: "#d8d0c0", contactRange: 74, healRadius: 220, healRate: 72, healAmount: 10 },

  // ===================== FLOOR 1: AZURINE CITY =====================
  // Levels 1-4: Gangsters & Goons
  neon_pickpocket: {
    name: "Neon Pickpocket", hp: 60, speed: 3.9, damage: 12, killHeal: 5,
    skin: "#8a7a6a", hair: "#1a1a2a", shirt: "#2a2a4a", pants: "#1a1a3a", contactRange: 74,
    ai: 'runner', _specials: ['swipe_blink'], specialCD: 420, // 7s
  },
  cyber_mugger: {
    name: "Cyber Mugger", hp: 90, speed: 3.3, damage: 16, killHeal: 8,
    skin: "#7a6a5a", hair: "#0a0a1a", shirt: "#3a3a5a", pants: "#2a2a3a", contactRange: 76,
    ai: 'grunt', _specials: ['stun_baton'], specialCD: 480, // 8s
  },
  drone_lookout: {
    name: "Drone Lookout", hp: 70, speed: 2.7, damage: 8, killHeal: 10,
    skin: "#6a6a7a", hair: "#2a2a3a", shirt: "#4a4a5a", pants: "#3a3a4a", contactRange: 74,
    ai: 'archer', _specials: ['spot_mark'], specialCD: 600, // 10s
    arrowRate: 100, arrowSpeed: 13.5, arrowRange: 350, arrowBounces: 0, arrowLife: 400,
    projectileStyle: 'neon_bolt',
  },
  street_chemist: {
    name: "Street Chemist", hp: 65, speed: 2.4, damage: 6, killHeal: 12,
  ...
  renegade_bruiser: {
    name: "Renegade Bruiser", hp: 200, speed: 3.0, damage: 22, killHeal: 15,
  ...
  renegade_shadowknife: {
    name: "Renegade Shadowknife", hp: 55, speed: 4.2, damage: 18, killHeal: 6,
  ...
  the_don: {
    ...
    arrowRate: 120, arrowSpeed: 15.3, arrowRange: 500, arrowBounces: 0, arrowLife: 500,
  ...
  velocity: {
    name: "Velocity", hp: 1500, speed: 3.8, damage: 30, killHeal: 50,
  ...
  coil_runner: {
    name: "Coil Runner", hp: 70, speed: 4.2, damage: 8, killHeal: 5,
  ...
  voltmaster: {
    name: "Voltmaster", hp: 1000, speed: 2.0, damage: 18, killHeal: 40,
  ...
  e_mortis: {
    ...
    arrowRate: 110, arrowSpeed: 15.3, arrowRange: 500, arrowBounces: 0, arrowLife: 500,
    projectileStyle: 'golden',
  ...
  mourn: {
    name: "Mourn", hp: 1200, speed: 1.5, damage: 24, killHeal: 40,
  ...
  centipede: {
    name: "Centipede", hp: 2200, speed: 1.8, damage: 20, killHeal: 50,
  ...
  game_master: {
    name: "Game Master", hp: 1400, speed: 1.8, damage: 18, killHeal: 40,
  ...
  junz: {
    name: "J.U.N.Z", hp: 2500, speed: 2.1, damage: 25, killHeal: 50,
    ...
    isBoss: true, bossScale: 1.5, specialCD: 540, // 9s
    arrowRate: 90, arrowSpeed: 18.9, arrowRange: 550, arrowBounces: 0, arrowLife: 500,
    projectileStyle: 'electric_bolt',
  ...
  lehvius: {
    name: "Lehvius", hp: 1600, speed: 2.7, damage: 22, killHeal: 40,
  ...
  jackman: {
    name: "Jackman", hp: 1200, speed: 2.1, damage: 16, killHeal: 40,
  ...
  biolum_drone: {
    name: "Bio-Lum Drone", hp: 55, speed: 3.9, damage: 10, killHeal: 5,
  ...
  malric: {
    name: "World Malric", hp: 3000, speed: 2.4, damage: 28, killHeal: 50,
  ...
  vale: {
    name: "Vale", hp: 2200, speed: 3.0, damage: 20, killHeal: 50,
