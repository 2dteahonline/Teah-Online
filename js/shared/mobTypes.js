...
const MOB_TYPES = {
  grunt:   { name: "Grunt",   hp: 106, speed: 3.6, damage: 18, killHeal: 10, goldReward: 2, skin: "#7a6050", hair: "#3a2a1a", shirt: "#556644", pants: "#3a3a2a", contactRange: 57, deathColors: ["#aa4444","#884444","#cc6666","#663333"] },
  runner:  { name: "Runner",  hp: 50,  speed: 4.3, damage: 10, killHeal: 3,  goldReward: 3, skin: "#8a7060", hair: "#1a1a1a", shirt: "#884444", pants: "#4a2a2a", contactRange: 56, deathColors: ["#cc6644","#aa4422","#ee8866","#883322"] },
  tank:    { name: "Tank",    hp: 375, speed: 3.2,  damage: 20, killHeal: 20, goldReward: 6, skin: "#6a5a50", hair: "#2a2a2a", shirt: "#445566", pants: "#2a3a4a", contactRange: 58, deathColors: ["#4466aa","#335588","#6688cc","#224466"] },
  witch:   { name: "Witch",   hp: 188, speed: 1.7, damage: 6,  killHeal: 25, goldReward: 7, skin: "#8a9a7a", hair: "#2a1a3a", shirt: "#3a2a4a", pants: "#2a1a2a", contactRange: 57, summonRate: 540, summonMax: 4, deathColors: ["#a060e0","#8040c0","#c080ff","#6020a0"] },
  skeleton:{ name: "Skeleton",hp: 38,  speed: 3.6, damage: 8,  killHeal: 1,  goldReward: 0, skin: "#d8d0c0", hair: "#d0c8b8", shirt: "#c8c0b0", pants: "#b8b0a0", contactRange: 56, deathColors: ["#d8d0c0","#c8c0b0","#e0d8c8","#b8b0a0"] },
  golem:   { name: "Golem",   hp: 1000,speed: 1.4, damage: 13, killHeal: 40, goldReward: 30, skin: "#6a6a6a", hair: "#555555", shirt: "#5a5a5a", pants: "#4a4a4a", contactRange: 62, boulderRate: 88, boulderSpeed: 9, boulderRange: 1000, summonRate: 300, summonMax: 3, deathColors: ["#8a8580","#6a6560","#a09a90","#585450"] },
  mini_golem: { name: "Mini Golem", hp: 120, speed: 1.8, damage: 6, killHeal: 10, goldReward: 5, skin: "#7a7a7a", hair: "#666666", shirt: "#6a6a6a", pants: "#5a5a5a", contactRange: 38, boulderRate: 140, boulderSpeed: 9, boulderRange: 500, deathColors: ["#9a9590","#7a7570","#b0aaa0","#686460"] },
  mummy:   { name: "Mummy",   hp: 56,  speed: 3.2,  damage: 0,  killHeal: 5,  goldReward: 3, skin: "#8a8580", hair: "#7a7570", shirt: "#6a6560", pants: "#5a5550", contactRange: 57, explodeRange: 140, explodeDamage: 28, fuseMin: 32, fuseMax: 96, deathColors: ["#c8b878","#a89858","#e0d098","#887838"] },
  archer:  { name: "Archer",  hp: 75,  speed: 2.7, damage: 6,  killHeal: 8,  goldReward: 4, skin: "#3a3530", hair: "#0e0e0e", shirt: "#111111", pants: "#1a1a1a", contactRange: 56, arrowRate: 80, arrowSpeed: 9, arrowRange: 400, arrowBounces: 4, arrowLife: 600, deathColors: ["#30ff20","#1a1a1a","#0e0e0e","#20cc10"] },
  healer:  { name: "Healer",  hp: 81,  speed: 2, damage: 5,  killHeal: 15, goldReward: 5, skin: "#e8d8c8", hair: "#f0e0c0", shirt: "#eee8dd", pants: "#d8d0c0", contactRange: 56, healRadius: 220, healRate: 72, healAmount: 10, deathColors: ["#ffdd30","#ffe870","#ffc800","#ffee90"] },

  // ===================== FLOOR 1: AZURINE CITY =====================
  // Levels 1-4: Gangsters & Goons
  neon_pickpocket: {
    name: "Neon Pickpocket", hp: 60, speed: 4.2, damage: 12, killHeal: 5, goldReward: 3,
    skin: "#8a7a6a", hair: "#1a1a2a", shirt: "#2a2a4a", pants: "#1a1a3a", contactRange: 56,
    ai: 'runner', _specials: ['swipe_blink'], specialCD: 420, // 7s
  },
  cyber_mugger: {
    name: "Cyber Mugger", hp: 90, speed: 3.4, damage: 16, killHeal: 8, goldReward: 4,
    skin: "#7a6a5a", hair: "#0a0a1a", shirt: "#3a3a5a", pants: "#2a2a3a", contactRange: 57,
    ai: 'grunt', _specials: ['stun_baton'], specialCD: 480, // 8s
  },
  drone_lookout: {
    name: "Drone Lookout", hp: 70, speed: 2.9, damage: 8, killHeal: 10, goldReward: 4,
  ...
  street_chemist: {
    name: "Street Chemist", hp: 65, speed: 2.6, damage: 6, killHeal: 12, goldReward: 5,
  ...
  renegade_bruiser: {
    name: "Renegade Bruiser", hp: 200, speed: 3.2, damage: 22, killHeal: 15, goldReward: 6,
  ...
  renegade_shadowknife: {
    name: "Renegade Shadowknife", hp: 55, speed: 4.5, damage: 18, killHeal: 6, goldReward: 4,
  ...
  renegade_demo: {
    name: "Renegade Demo", hp: 80, speed: 3.2, damage: 14, killHeal: 8, goldReward: 5,
    skin: "#7a6a5a", hair: "#2a1a1a", shirt: "#5a4a3a", pants: "#4a3a2a", contactRange: 57,
    ai: 'grunt', _specials: ['sticky_bomb'], specialCD: 720, // 12s
  },
  renegade_sniper: {
    name: "Renegade Sniper", hp: 70, speed: 2.7, damage: 10, killHeal: 10, goldReward: 5,
  ...
  velocity: {
    name: "Velocity", hp: 1500, speed: 4.1, damage: 30, killHeal: 50, goldReward: 40,
  ...
  coil_runner: {
    name: "Coil Runner", hp: 70, speed: 4.5, damage: 8, killHeal: 5, goldReward: 4,
  ...
  voltmaster: {
    name: "Voltmaster", hp: 1000, speed: 2.2, damage: 18, killHeal: 40, goldReward: 30,
  ...
  e_mortis: {
    name: "E-Mortis", hp: 1800, speed: 2.5, damage: 22, killHeal: 50, goldReward: 45,
  ...
  mourn: {
    name: "Mourn", hp: 1200, speed: 1.6, damage: 24, killHeal: 40, goldReward: 35,
  ...
  junz: {
    name: "J.U.N.Z", hp: 2500, speed: 2.2, damage: 25, killHeal: 50, goldReward: 55,
  ...
  rabid_hyenaoid: {
    name: "Rabid Hyenaoid", hp: 105, speed: 4.3, damage: 18, killHeal: 6, goldReward: 5,
  ...
  spore_stag: {
    name: "Spore Stag", hp: 120, speed: 3.7, damage: 20, killHeal: 8, goldReward: 6,
  ...
  wasteland_raptor: {
    name: "Wasteland Raptor", hp: 95, speed: 4.6, damage: 16, killHeal: 5, goldReward: 4,
  ...
  plague_batwing: {
    name: "Plague Batwing", hp: 70, speed: 4.1, damage: 12, killHeal: 8, goldReward: 5,
  ...
  lehvius: {
    name: "Lehvius", hp: 1900, speed: 3.1, damage: 26, killHeal: 40, goldReward: 45,
  ...
  jackman: {
    name: "Jackman", hp: 1500, speed: 2.5, damage: 19, killHeal: 40, goldReward: 40,
  ...
  gel_swordsman: {
    name: "Gel Swordsman", hp: 100, speed: 4.1, damage: 16, killHeal: 6, goldReward: 5,
  ...
  viscosity_mage: {
    name: "Viscosity Mage", hp: 80, speed: 2.7, damage: 10, killHeal: 10, goldReward: 5,
  ...
  core_guardian: {
    name: "Core Guardian Blob", hp: 175, speed: 3.1, damage: 14, killHeal: 10, goldReward: 7,
  ...
  biolum_drone: {
    name: "Bio-Lum Drone", hp: 65, speed: 4.3, damage: 12, killHeal: 5, goldReward: 4,
  ...
  malric: {
    name: "World Malric", hp: 3600, speed: 2.7, damage: 32, killHeal: 50, goldReward: 60,
  ...
  vale: {
    name: "Vale", hp: 2600, speed: 3.4, damage: 24, killHeal: 50, goldReward: 55,
  ...
  bilge_rat: {
    name: "Bilge Rat", hp: 60, speed: 4.2, damage: 10, killHeal: 5, goldReward: 3,
  ...
  powder_keg: {
    name: "Powder Keg", hp: 90, speed: 3.2, damage: 14, killHeal: 8, goldReward: 4,
  ...
  deckhand_shooter: {
    name: "Deckhand Shooter", hp: 70, speed: 2.7, damage: 8, killHeal: 10, goldReward: 4,
  ...
  anchor_hauler: {
    name: "Anchor Hauler", hp: 150, speed: 2.6, damage: 18, killHeal: 15, goldReward: 6,
  ...
  captain_husa: {
    name: "Captain Husa", hp: 900, speed: 2.2, damage: 22, killHeal: 40, goldReward: 25,
  ...
  ironclad_marine: {
    name: "Ironclad Marine", hp: 180, speed: 2.9, damage: 20, killHeal: 15, goldReward: 6,
  ...
  tidecaller_mystic: {
    name: "Tidecaller Mystic", hp: 80, speed: 2.6, damage: 10, killHeal: 12, goldReward: 5,
  ...
  galleon_sniper: {
    name: "Galleon Sniper", hp: 70, speed: 2.7, damage: 10, killHeal: 10, goldReward: 5,
  ...
  sunken_dreadnought: {
    name: "Sunken Dreadnought", hp: 220, speed: 2.2, damage: 24, killHeal: 15, goldReward: 7,
  ...
  jungle_headhunter: {
    name: "Jungle Headhunter", hp: 80, speed: 4.2, damage: 14, killHeal: 5, goldReward: 4,
  ...
  voodoo_creeper: {
    name: "Voodoo Creeper", hp: 70, speed: 2.6, damage: 8, killHeal: 12, goldReward: 5,
  ...
  canopy_sniper: {
    name: "Canopy Sniper", hp: 65, speed: 2.9, damage: 10, killHeal: 10, goldReward: 5,
  ...
  temple_silverback: {
    name: "Temple Silverback", hp: 200, speed: 2.9, damage: 22, killHeal: 15, goldReward: 6,
  ...
  zongo: {
    name: "Zongo", hp: 1100, speed: 2.3, damage: 26, killHeal: 40, goldReward: 30,
  ...
  crimson_corsair: {
    name: "Crimson Corsair", hp: 85, speed: 4.1, damage: 16, killHeal: 5, goldReward: 4,
  ...
  crystal_cultist: {
    name: "Crystal Cultist", hp: 75, speed: 2.6, damage: 10, killHeal: 12, goldReward: 5,
  ...
  bone_clad_brute: {
    name: "Bone-Clad Brute", hp: 190, speed: 2.7, damage: 20, killHeal: 15, goldReward: 6,
  ...
  sanguine_siren: {
    name: "Sanguine Siren", hp: 70, speed: 2.9, damage: 12, killHeal: 10, goldReward: 5,
  ...
  bloodborne_marlon: {
    name: "Bloodborne Marlon", hp: 1500, speed: 2.2, damage: 28, killHeal: 40, goldReward: 35,
  ...
  feral_deckhand: {
    name: "Feral Deckhand", hp: 90, speed: 4.5, damage: 16, killHeal: 5, goldReward: 4,
  ...
  howling_lookout: {
    name: "Howling Lookout", hp: 75, speed: 2.9, damage: 10, killHeal: 10, goldReward: 5,
  ...
  sea_dog_brute: {
    name: "Sea Dog Brute", hp: 180, speed: 3.2, damage: 22, killHeal: 15, goldReward: 6,
  ...
  rabid_wharf_hound: {
    name: "Rabid Wharf Hound", hp: 100, speed: 3.7, damage: 18, killHeal: 8, goldReward: 4,
  ...
  wolfbeard: {
    name: "Wolfbeard", hp: 1600, speed: 2.9, damage: 28, killHeal: 40, goldReward: 35,
  ...
  phantom_swashbuckler: {
    name: "Phantom Swashbuckler", hp: 80, speed: 4.2, damage: 18, killHeal: 5, goldReward: 4,
  ...
  poltergeist_gunner: {
    name: "Poltergeist Gunner", hp: 70, speed: 2.7, damage: 12, killHeal: 10, goldReward: 5,
  ...
  drowned_banshee: {
    name: "Drowned Banshee", hp: 75, speed: 2.6, damage: 10, killHeal: 12, goldReward: 5,
  ...
  cursed_shackler: {
    name: "Cursed Shackler", hp: 120, speed: 3.2, damage: 16, killHeal: 8, goldReward: 5,
  ...
  ghostbeard: {
    name: "Ghostbeard", hp: 1800, speed: 2.6, damage: 26, killHeal: 40, goldReward: 35,
  ...
  ink_spitter: {
    name: "Ink Spitter", hp: 80, speed: 4.1, damage: 12, killHeal: 5, goldReward: 4,
  ...
  coral_crusher: {
    name: "Coral Crusher", hp: 200, speed: 2.6, damage: 22, killHeal: 15, goldReward: 6,
  ...
  barnacle_bomber: {
    name: "Barnacle Bomber", hp: 90, speed: 3.4, damage: 16, killHeal: 8, goldReward: 4,
  ...
  kraken_jim: {
    name: "Kraken Jim", hp: 2200, speed: 1.7, damage: 28, killHeal: 50, goldReward: 40,
  ...
  gilded_triton: {
    name: "Gilded Triton", hp: 100, speed: 4.2, damage: 20, killHeal: 5, goldReward: 5,
  ...
  coin_spitter_jelly: {
    name: "Coin Spitter Jelly", hp: 75, speed: 2.7, damage: 12, killHeal: 10, goldReward: 5,
  ...
  deep_sea_dredger: {
    name: "Deep-Sea Dredger", hp: 210, speed: 2.3, damage: 24, killHeal: 15, goldReward: 7,
  ...
  royal_cephalopod: {
    name: "Royal Cephalopod", hp: 85, speed: 2.6, damage: 12, killHeal: 12, goldReward: 5,
  ...
  alabaster_sentinel: {
    name: "Alabaster Sentinel", hp: 180, speed: 3.2, damage: 22, killHeal: 15, goldReward: 6,
  ...
  reef_weaver: {
    name: "Reef Weaver", hp: 80, speed: 2.6, damage: 12, killHeal: 12, goldReward: 5,
  ...
  gilded_manta: {
    name: "Gilded Manta", hp: 100, speed: 4.5, damage: 18, killHeal: 5, goldReward: 5,
  ...
  royal_shell_knight: {
    name: "Royal Shell Knight", hp: 220, speed: 2.6, damage: 24, killHeal: 15, goldReward: 7,
  ...
  queen_siralyth: {
    name: "Queen Siralyth", hp: 3200, speed: 2.2, damage: 30, killHeal: 50, goldReward: 50,
  ...
  sea_serpent_spawn: {
    name: "Sea Serpent Spawn", hp: 110, speed: 4.3, damage: 20, killHeal: 5, goldReward: 5,
  ...
  living_whirlpool: {
    name: "Living Whirlpool", hp: 90, speed: 2.3, damage: 14, killHeal: 12, goldReward: 5,
  ...
  bone_tooth_zealot: {
    name: "Bone Tooth Zealot", hp: 130, speed: 3.4, damage: 22, killHeal: 8, goldReward: 5,
  ...
  tidal_avatar: {
    name: "Tidal Avatar", hp: 240, speed: 2.7, damage: 26, killHeal: 15, goldReward: 7,
  ...
  mami_wata: {
    name: "Mami Wata", hp: 4000, speed: 2.3, damage: 34, killHeal: 50, goldReward: 60,
  ...
  scrap_metal_scrounger: {
    name: "Scrap Metal Scrounger", hp: 140, speed: 3.4, damage: 20, killHeal: 8, goldReward: 5,
  ...
  junkyard_hound: {
    name: "Junkyard Hound", hp: 110, speed: 4.5, damage: 22, killHeal: 5, goldReward: 4,
  ...
  alleyway_lookout: {
    name: "Alleyway Lookout", hp: 120, speed: 2.7, damage: 20, killHeal: 10, goldReward: 5,
  ...
  patchwork_thug: {
    name: "Patchwork Thug", hp: 160, speed: 3.6, damage: 24, killHeal: 8, goldReward: 5,
  ...
  willis: {
    name: "Willis", hp: 2500, speed: 2.9, damage: 38, killHeal: 50, goldReward: 40,
  ...
  butcher_block_maniac: {
    name: "Butcher Block Maniac", hp: 180, speed: 3.6, damage: 26, killHeal: 8, goldReward: 5,
  ...
  adrenaline_fiend: {
    name: "Adrenaline Fiend", hp: 140, speed: 4.6, damage: 28, killHeal: 5, goldReward: 4,
  ...
  nail_gunner: {
    name: "Nail Gunner", hp: 150, speed: 2.6, damage: 22, killHeal: 10, goldReward: 6,
  ...
  aerosol_pyro: {
    name: "Aerosol Pyro", hp: 200, speed: 3.2, damage: 30, killHeal: 12, goldReward: 6,
  ...
  puppedrill: {
    name: "Puppedrill", hp: 3000, speed: 2.7, damage: 42, killHeal: 50, goldReward: 45,
  ...
  chain_gang_brawler: {
    name: "Chain Gang Brawler", hp: 190, speed: 3.6, damage: 26, killHeal: 8, goldReward: 6,
  ...
  syndicate_enforcer: {
    name: "Syndicate Enforcer", hp: 170, speed: 2.7, damage: 28, killHeal: 10, goldReward: 6,
  ...
  riot_juggernaut: {
    name: "Riot Juggernaut", hp: 280, speed: 2.9, damage: 34, killHeal: 15, goldReward: 7,
  ...
  macabre_dancer: {
    name: "Macabre Dancer", hp: 150, speed: 4.2, damage: 24, killHeal: 5, goldReward: 5,
  ...
  arsonist: {
    name: "Arsonist", hp: 200, speed: 3.6, damage: 28, killHeal: 8, goldReward: 6,
  ...
  sackhead: {
    name: "Sackhead", hp: 3500, speed: 3.2, damage: 46, killHeal: 50, goldReward: 50,
  ...
  executioner_bruiser: {
    name: "Executioner Bruiser", hp: 220, speed: 3.7, damage: 30, killHeal: 8, goldReward: 6,
  ...
  laser_grid_thief: {
    name: "Laser Grid Thief", hp: 160, speed: 4.5, damage: 26, killHeal: 5, goldReward: 5,
  ...
  tactical_spotter: {
    name: "Tactical Spotter", hp: 170, speed: 2.6, damage: 24, killHeal: 10, goldReward: 6,
  ...
  tommy_gun_heavy: {
    name: "Tommy Gun Heavy", hp: 260, speed: 3.2, damage: 32, killHeal: 12, goldReward: 7,
  ...
  breacher_unit: {
    name: "Breacher Unit", hp: 210, speed: 3.7, damage: 28, killHeal: 8, goldReward: 6,
  ...
  mr_schwallie: {
    name: "Mr. Schwallie", hp: 4000, speed: 3.4, damage: 50, killHeal: 50, goldReward: 55,
  ...
  sledgehammer_brute: {
    name: "Sledgehammer Brute", hp: 250, speed: 3.4, damage: 32, killHeal: 8, goldReward: 6,
  ...
  stagehand_brute: {
    name: "Stagehand Brute", hp: 230, speed: 3.6, damage: 30, killHeal: 8, goldReward: 6,
  ...
  juggling_jester: {
    name: "Juggling Jester", hp: 170, speed: 4.2, damage: 24, killHeal: 5, goldReward: 5,
  ...
  killer_mime: {
    name: "Killer Mime", hp: 4000, speed: 3.2, damage: 48, killHeal: 50, goldReward: 55,
  ...
  illusionist: {
    name: "Illusionist", hp: 200, speed: 2.2, damage: 26, killHeal: 12, goldReward: 6,
  ...
  prop_master: {
    name: "Prop Master", hp: 210, speed: 2.9, damage: 28, killHeal: 10, goldReward: 6,
  ...
  disco_brawler: {
    name: "Disco Brawler", hp: 190, speed: 4.2, damage: 30, killHeal: 5, goldReward: 5,
  ...
  phantom_chorus: {
    name: "Phantom Chorus", hp: 220, speed: 1.7, damage: 24, killHeal: 12, goldReward: 7,
  ...
  major_phantom: {
    name: "Major Phantom", hp: 4500, speed: 2.9, damage: 52, killHeal: 50, goldReward: 60,
  ...
  tracksuit_goon: {
    name: "Tracksuit Goon", hp: 240, speed: 3.6, damage: 30, killHeal: 8, goldReward: 7,
  ...
  casino_pit_boss: {
    name: "Casino Pit Boss", hp: 270, speed: 3.7, damage: 34, killHeal: 8, goldReward: 7,
  ...
  smokescreen_smuggler: {
    name: "Smokescreen Smuggler", hp: 210, speed: 1.7, damage: 24, killHeal: 12, goldReward: 6,
  ...
  lady_red: {
    name: "Lady Red", hp: 4800, speed: 3.4, damage: 54, killHeal: 50, goldReward: 60,
  ...
  the_cleaner: {
    name: "The Cleaner", hp: 250, speed: 2.7, damage: 32, killHeal: 10, goldReward: 7,
  ...
  lockdown_sentinel: {
    name: "Lockdown Sentinel", hp: 320, speed: 3.2, damage: 36, killHeal: 15, goldReward: 8,
  ...
  sprayer_drone: {
    name: "Sprayer Drone", hp: 180, speed: 2.6, damage: 26, killHeal: 10, goldReward: 6,
  ...
  mad_assistant: {
    name: "Mad Assistant", hp: 220, speed: 2.6, damage: 28, killHeal: 10, goldReward: 7,
  ...
  the_boss_e205: {
    name: "The Boss", hp: 5200, speed: 3.2, damage: 58, killHeal: 50, goldReward: 65,
  ...
  hazmat_grunt: {
    name: "Hazmat Grunt", hp: 290, speed: 3.6, damage: 34, killHeal: 8, goldReward: 7,
  ...
  sludge_crawler: {
    name: "Sludge Crawler", hp: 220, speed: 4.2, damage: 30, killHeal: 5, goldReward: 6,
  ...
  irradiated_walker: {
    name: "Irradiated Walker", hp: 250, speed: 1.6, damage: 28, killHeal: 12, goldReward: 7,
  ...
  chem_brute: {
    name: "Chem Brute", hp: 310, speed: 3.4, damage: 36, killHeal: 10, goldReward: 7,
  ...
  lady_elixir: {
    name: "Lady Elixir", hp: 5500, speed: 2.7, damage: 56, killHeal: 50, goldReward: 65,
  ...
  failed_specimen: {
    name: "Failed Specimen", hp: 260, speed: 4.5, damage: 32, killHeal: 5, goldReward: 6,
  ...
  reactor_technician: {
    name: "Reactor Technician", hp: 240, speed: 2.9, damage: 30, killHeal: 10, goldReward: 7,
  ...
  lockdown_sentinel_e205: {
    name: "Lockdown Sentinel Mk2", hp: 350, speed: 3.4, damage: 38, killHeal: 15, goldReward: 8,
  ...
  nofaux: {
    name: "Nofaux", hp: 6000, speed: 3.7, damage: 60, killHeal: 50, goldReward: 75,
  ...
  silk_skitterer: {
    name: "Silk Skitterer", hp: 200, speed: 4.8, damage: 28, killHeal: 8, goldReward: 5,
  ...
  needleback_weaver: {
    name: "Needleback Weaver", hp: 230, speed: 3.2, damage: 30, killHeal: 10, goldReward: 6,
  ...
  brood_lantern_mite: {
    name: "Brood Lantern Mite", hp: 250, speed: 3.2, damage: 28, killHeal: 12, goldReward: 7,
  ...
  silk_coffin_widow: {
    name: "Silk Coffin Widow", hp: 280, speed: 3.4, damage: 35, killHeal: 15, goldReward: 8,
  ...
  sichou: {
    name: "Sichou", hp: 3500, speed: 4.1, damage: 45, killHeal: 40, goldReward: 30,
  ...
  copperhide_hoglet: {
    name: "Copperhide Hoglet", hp: 240, speed: 3.7, damage: 32, killHeal: 10, goldReward: 6,
  ...
  tusk_raider: {
    name: "Tusk Raider", hp: 210, speed: 4.5, damage: 30, killHeal: 8, goldReward: 5,
  ...
  bronzeback_crusher: {
    name: "Bronzeback Crusher", hp: 280, speed: 3.2, damage: 34, killHeal: 15, goldReward: 8,
  ...
  warboar_drummer: {
    name: "Warboar Drummer", hp: 220, speed: 3.2, damage: 28, killHeal: 12, goldReward: 7,
  ...
  tongya: {
    name: "Tongya", hp: 4000, speed: 3.2, damage: 50, killHeal: 50, goldReward: 40,
  ...
  temple_fang_acolyte: {
    name: "Temple Fang Acolyte", hp: 280, speed: 4.2, damage: 32, killHeal: 10, goldReward: 6,
  ...
  jade_idol_watcher: {
    name: "Jade Idol Watcher", hp: 340, speed: 3.4, damage: 36, killHeal: 14, goldReward: 8,
  ...
  coil_priestess: {
    name: "Coil Priestess", hp: 300, speed: 3.2, damage: 34, killHeal: 16, goldReward: 9,
  ...
  jade_vein_stalker: {
    name: "Jade Vein Stalker", hp: 310, speed: 4.2, damage: 38, killHeal: 12, goldReward: 7,
  ...
  jade_serpent: {
    name: "Jade Serpent", hp: 4500, speed: 4.1, damage: 50, killHeal: 40, goldReward: 35,
  ...
  rubblebound_sentinel: {
    name: "Rubblebound Sentinel", hp: 380, speed: 3.2, damage: 38, killHeal: 15, goldReward: 8,
  ...
  pillarbreaker_brute: {
    name: "Pillarbreaker Brute", hp: 340, speed: 3.6, damage: 40, killHeal: 12, goldReward: 7,
  ...
  mausoleum_warden: {
    name: "Mausoleum Warden", hp: 360, speed: 3.4, damage: 36, killHeal: 14, goldReward: 8,
  ...
  stone_golem_guardian: {
    name: "Stone Golem Guardian", hp: 5000, speed: 2.7, damage: 55, killHeal: 50, goldReward: 45,
  ...
  tempest_spearman: {
    name: "Tempest Spearman", hp: 380, speed: 3.7, damage: 42, killHeal: 14, goldReward: 8,
  ...
  cloudscale_archer: {
    name: "Cloudscale Archer", hp: 400, speed: 3.2, damage: 40, killHeal: 16, goldReward: 9,
  ...
  tideblade_disciple: {
    name: "Tideblade Disciple", hp: 420, speed: 3.6, damage: 44, killHeal: 14, goldReward: 8,
  ...
  thunder_crest_knight: {
    name: "Thunder Crest Knight", hp: 460, speed: 3.4, damage: 46, killHeal: 16, goldReward: 9,
  ...
  azure_dragon: {
    name: "Azure Dragon", hp: 5500, speed: 4.2, damage: 55, killHeal: 50, goldReward: 40,
  ...
  ember_guard: {
    name: "Ember Guard", hp: 440, speed: 3.7, damage: 44, killHeal: 14, goldReward: 8,
  ...
  furnace_hound: {
    name: "Furnace Hound", hp: 400, speed: 4.8, damage: 42, killHeal: 12, goldReward: 7,
  ...
  ashen_banner_monk: {
    name: "Ashen Banner Monk", hp: 420, speed: 3.2, damage: 38, killHeal: 18, goldReward: 10,
  ...
  crimson_furnace_captain: {
    name: "Crimson Furnace Captain", hp: 480, speed: 3.6, damage: 48, killHeal: 20, goldReward: 10,
  ...
  jaja: {
    name: "Jaja", hp: 6000, speed: 3.2, damage: 60, killHeal: 60, goldReward: 50,
  ...
  ashen_blade_retainer: {
    name: "Ashen Blade Retainer", hp: 470, speed: 4.1, damage: 46, killHeal: 16, goldReward: 9,
  ...
  lantern_veil_assassin: {
    name: "Lantern Veil Assassin", hp: 450, speed: 5.3, damage: 42, killHeal: 15, goldReward: 8,
  ...
  blood_script_archer: {
    name: "Blood Script Archer", hp: 480, speed: 3.7, damage: 44, killHeal: 18, goldReward: 10,
  ...
  crimson_gate_executioner: {
    name: "Crimson Gate Executioner", hp: 550, speed: 3.7, damage: 52, killHeal: 22, goldReward: 11,
  ...
  gensai: {
    name: "Gensai", hp: 6500, speed: 4.8, damage: 60, killHeal: 50, goldReward: 45,
  ...
  lunar_dust_hare: {
    name: "Lunar Dust Hare", hp: 460, speed: 5.3, damage: 44, killHeal: 15, goldReward: 8,
  ...
  crescent_mirror_wisp: {
    name: "Crescent Mirror Wisp", hp: 480, speed: 3.7, damage: 42, killHeal: 18, goldReward: 9,
  ...
  gravity_ear_monk: {
    name: "Gravity Ear Monk", hp: 500, speed: 3.7, damage: 46, killHeal: 20, goldReward: 10,
  ...
  eclipse_burrower: {
    name: "Eclipse Burrower", hp: 520, speed: 4.8, damage: 50, killHeal: 18, goldReward: 9,
  ...
  moon_rabbit: {
    name: "Moon Rabbit", hp: 7000, speed: 4.1, damage: 65, killHeal: 60, goldReward: 55,
  ...
  miregulp_tadpole: {
    name: "Miregulp Tadpole", hp: 520, speed: 4.8, damage: 48, killHeal: 18, goldReward: 9,
  ...
  gulchspine_bloater: {
    name: "Gulchspine Bloater", hp: 600, speed: 3.7, damage: 52, killHeal: 20, goldReward: 10,
  ...
  hymn_eater_toadlet: {
    name: "Hymn Eater Toadlet", hp: 560, speed: 3.7, damage: 48, killHeal: 22, goldReward: 11,
  ...
  abyssal_swallower: {
    name: "Abyssal Swallower", hp: 650, speed: 3.7, damage: 56, killHeal: 25, goldReward: 12,
  ...
  celestial_toad: {
    name: "Celestial Toad", hp: 7500, speed: 3.7, damage: 65, killHeal: 60, goldReward: 50,
  ...
  shrine_shard_monkey: {
    name: "Shrine Shard Monkey", hp: 540, speed: 5.3, damage: 50, killHeal: 18, goldReward: 9,
  ...
  seal_fragment_sprite: {
    name: "Seal Fragment Sprite", hp: 580, speed: 3.7, damage: 48, killHeal: 22, goldReward: 11,
  ...
  thundertail_ape: {
    name: "Thundertail Ape", hp: 620, speed: 4.1, damage: 54, killHeal: 20, goldReward: 10,
  ...
  heavens_gate_breaker: {
    name: "Heaven's Gate Breaker", hp: 650, speed: 3.7, damage: 58, killHeal: 25, goldReward: 12,
  ...
  lord_sarugami: {
    name: "Lord Sarugami", hp: 8500, speed: 4.2, damage: 75, killHeal: 70, goldReward: 65,
  ...
  chip_runner: {
    name: "Chip Runner", hp: 240, speed: 4.5, damage: 30, killHeal: 8, goldReward: 5,
  ...
  pit_bruiser: {
    name: "Pit Bruiser", hp: 350, speed: 2.9, damage: 38, killHeal: 15, goldReward: 8,
  ...
  velvet_knifer: {
    name: "Velvet Knifer", hp: 260, speed: 4.1, damage: 32, killHeal: 10, goldReward: 6,
  ...
  vault_hound_e216: {
    name: "Vault Hound", hp: 220, speed: 5, damage: 28, killHeal: 6, goldReward: 5,
  ...
  victor_graves: {
    name: "Victor Graves", hp: 4000, speed: 2.9, damage: 48, killHeal: 40, goldReward: 30,
  ...
  gilded_maid: {
    name: "Gilded Maid", hp: 280, speed: 3.6, damage: 34, killHeal: 12, goldReward: 7,
  ...
  cashmere_viper: {
    name: "Cashmere Viper", hp: 230, speed: 4.5, damage: 30, killHeal: 8, goldReward: 6,
  ...
  jewel_wraith: {
    name: "Jewel Wraith", hp: 300, speed: 3.2, damage: 32, killHeal: 14, goldReward: 8,
  ...
  bullion_knight: {
    name: "Bullion Knight", hp: 380, speed: 2.9, damage: 40, killHeal: 16, goldReward: 9,
  ...
  madame_midas: {
    name: "Madame Midas", hp: 5000, speed: 3.4, damage: 52, killHeal: 50, goldReward: 40,
  ...
  scar_punk: {
    name: "Scar Punk", hp: 270, speed: 4.2, damage: 34, killHeal: 10, goldReward: 6,
  ...
  splitjaw: {
    name: "Splitjaw", hp: 240, speed: 4.5, damage: 32, killHeal: 8, goldReward: 5,
  ...
  razorback_youth: {
    name: "Razorback Youth", hp: 210, speed: 5, damage: 28, killHeal: 6, goldReward: 5,
  ...
  grin_stitcher: {
    name: "Grin Stitcher", hp: 290, speed: 3.6, damage: 34, killHeal: 12, goldReward: 7,
  ...
  slasher_e216: {
    name: "Slasher", hp: 4500, speed: 4.2, damage: 52, killHeal: 40, goldReward: 35,
  ...
  chorus_shade: {
    name: "Chorus Shade", hp: 310, speed: 3.4, damage: 34, killHeal: 14, goldReward: 8,
  ...
  spotlight_stalker: {
    name: "Spotlight Stalker", hp: 250, speed: 4.5, damage: 32, killHeal: 8, goldReward: 6,
  ...
  velvet_mourner: {
    name: "Velvet Mourner", hp: 300, speed: 3.7, damage: 34, killHeal: 14, goldReward: 8,
  ...
  static_tenor: {
    name: "Static Tenor", hp: 270, speed: 3.4, damage: 30, killHeal: 12, goldReward: 7,
  ...
  blackout_belle: {
    name: "Blackout Belle", hp: 5500, speed: 4.8, damage: 55, killHeal: 50, goldReward: 45,
  ...
  marrow_guard: {
    name: "Marrow Guard", hp: 360, speed: 3.2, damage: 38, killHeal: 15, goldReward: 8,
  ...
  candle_child: {
    name: "Candle Child", hp: 260, speed: 3.6, damage: 32, killHeal: 10, goldReward: 6,
  ...
  ofrenda_keeper: {
    name: "Ofrenda Keeper", hp: 320, speed: 2.9, damage: 30, killHeal: 16, goldReward: 9,
  ...
  grave_trumpeter: {
    name: "Grave Trumpeter", hp: 280, speed: 3.4, damage: 32, killHeal: 12, goldReward: 7,
  ...
  macabre_e216: {
    name: "Macabre", hp: 5000, speed: 3.6, damage: 55, killHeal: 40, goldReward: 35,
  ...
  veil_sister: {
    name: "Veil Sister", hp: 320, speed: 3.2, damage: 34, killHeal: 16, goldReward: 9,
  ...
  candle_bride: {
    name: "Candle Bride", hp: 280, speed: 3.6, damage: 36, killHeal: 12, goldReward: 7,
  ...
  rosary_fencer: {
    name: "Rosary Fencer", hp: 260, speed: 4.1, damage: 34, killHeal: 10, goldReward: 7,
  ...
  choir_widow: {
    name: "Choir Widow", hp: 300, speed: 3.4, damage: 32, killHeal: 14, goldReward: 8,
  ...
  rosa_calavera: {
    name: "Rosa Calavera", hp: 6000, speed: 3.2, damage: 58, killHeal: 50, goldReward: 45,
  ...
  chain_gremlin: {
    name: "Chain Gremlin", hp: 250, speed: 4.5, damage: 32, killHeal: 8, goldReward: 6,
  ...
  road_reaper: {
    name: "Road Reaper", hp: 280, speed: 4.2, damage: 36, killHeal: 10, goldReward: 7,
  ...
  furnace_knuckle: {
    name: "Furnace Knuckle", hp: 380, speed: 3.2, damage: 40, killHeal: 16, goldReward: 9,
  ...
  rev_hound: {
    name: "Rev Hound", hp: 220, speed: 5.3, damage: 30, killHeal: 6, goldReward: 5,
  ...
  motor_demon: {
    name: "Motor Demon", hp: 5500, speed: 4.1, damage: 58, killHeal: 40, goldReward: 35,
  ...
  drift_phantom: {
    name: "Drift Phantom", hp: 240, speed: 5.3, damage: 34, killHeal: 8, goldReward: 6,
    skin: "#5a5a6a", hair: "#1a1a2a", shirt: "#3a3a4a", pants: "#1a1a2a", contactRange: 56,
    ai: 'runner', _specials: ['drift_blink'], specialCD: 420, // 7s
    deathColors: ["#5a5a6a","#3a3a4a","#7a7a8a","#1a1a2a"],
  },
  crash_dummy: {
    name: "Crash Dummy", hp: 300, speed: 3.7, damage: 38, killHeal: 12, goldReward: 7,
  ...
  neon_screamer: {
    name: "Neon Screamer", hp: 280, speed: 4.2, damage: 34, killHeal: 14, goldReward: 8,
  ...
  ramp_widow: {
    name: "Ramp Widow", hp: 290, speed: 3.7, damage: 36, killHeal: 14, goldReward: 8,
  ...
  nitro_wraith: {
    name: "Nitro Wraith", hp: 6500, speed: 5.3, damage: 62, killHeal: 50, goldReward: 45,
  ...
  cardling: {
    name: "Cardling", hp: 240, speed: 4.5, damage: 32, killHeal: 8, goldReward: 6,
  ...
  pit_oracle: {
    name: "Pit Oracle", hp: 320, speed: 3.4, damage: 34, killHeal: 16, goldReward: 9,
  ...
  roulette_revenant: {
    name: "Roulette Revenant", hp: 290, speed: 3.7, damage: 36, killHeal: 12, goldReward: 7,
  ...
  suit_reaper: {
    name: "Suit Reaper", hp: 280, speed: 3.6, damage: 36, killHeal: 12, goldReward: 7,
  ...
  hollow_ace: {
    name: "Hollow Ace", hp: 6000, speed: 4.1, damage: 60, killHeal: 40, goldReward: 40,
  ...
  grin_apostle: {
    name: "Grin Apostle", hp: 260, speed: 4.5, damage: 34, killHeal: 10, goldReward: 7,
  ...
  alcazar: {
    name: "Alcazar", hp: 8500, speed: 3.6, damage: 70, killHeal: 70, goldReward: 65,
