...
| 17 | Graphics Parity | DONE | 2026-03-29 | 2026-03-30 | **Slice 1**: SceneTileRenderer (17 scenes), TextureCanvas, CharacterRenderer, MobRenderer, GraphicsParityTest (20 tests). **Slice 2**: HitEffectRenderer (73 types, 6 templates). **Slice 3**: BulletSystem (13 projectile styles). **Slice 4**: HideSeekFOV, MafiaFOV (DDA raycasting), SecurityCameraOverlay, StatusOverlays, CrewmateRenderer, MinimapUI (room labels, dots). **Slice 5**: Walk-frame fix, EntityRendererRegistry (208 types: +29 missing), MobWorldObjects (16 categories). |
